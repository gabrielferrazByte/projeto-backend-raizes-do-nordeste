import { C as credentialWorkspaceId, D as credentialsRequiredError, E as credentialWorkspaceMismatchError, S as claimedIdentity, b as readActiveAccessToken, k as noSessionForWorkspaceError, t as buildEngine, x as claimedExpiresAt } from "./engine-ChihWB8y.js";
...
function createTestCli(spec) {
	...
	*  lands in the run's cwd — where the real loader would discover it. */
	const loadConfigFor = (cwd) => spec.loadConfig ?? (async (configPath) => ({
		files: [{
