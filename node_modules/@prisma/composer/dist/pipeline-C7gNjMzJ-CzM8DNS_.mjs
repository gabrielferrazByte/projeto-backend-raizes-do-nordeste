...
function configSource(request) {
	...
	const effectConflict = effectResolutionDiagnostic(request.cwd ?? path$1.dirname(resolvedEntry));
	...
	if (!path$1.isAbsolute(configPath)) return {
		ok: false,
		path: configPath,
...
//# sourceMappingURL=pipeline-C7gNjMzJ-CzM8DNS_.mjs.map