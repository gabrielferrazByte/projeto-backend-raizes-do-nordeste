...
async function deployWithDeps(input, deps) {
	...
	let executor;
	try {
		executor = await import("./execute-deploy-destroy-CvKCwVkD-Di3Ooeip.mjs");
	} catch (error) {
...
async function devWithDeps(input, deps) {
	...
	let executor;
	try {
		executor = await import("./execute-dev-BLCK5wF7-CJvkj5wl.mjs");
	} catch (error) {
...
async function logWithDeps(input, deps) {
	...
	let executor;
	try {
		executor = await import("./execute-log-B_zCJ17b-CE954g1a.mjs");
	} catch (error) {
