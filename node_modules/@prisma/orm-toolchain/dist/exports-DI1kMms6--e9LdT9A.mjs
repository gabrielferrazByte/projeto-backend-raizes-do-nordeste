...
//#region ../../../1-framework/3-tooling/emitter/dist/exports-DI1kMms6.mjs
...
async function emit(contract, stack, targetFamily, options) {
	...
	return {
		...
		contractDts: await format(generateContractDts(options.deserializeContract(canonicalized), targetFamily, codecTypeImports ?? [], contractTypeHashes, generateOptions, stack.codecLookup, options.resolveImportSpecifier ?? keepInternalSpecifiers), {
			parser: "typescript",
			singleQuote: true,
			semi: true,
			printWidth: 100
...
//# sourceMappingURL=exports-DI1kMms6--e9LdT9A.mjs.map