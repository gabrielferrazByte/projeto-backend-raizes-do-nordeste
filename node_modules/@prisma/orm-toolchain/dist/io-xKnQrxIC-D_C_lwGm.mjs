import { E as errorMissingFile, S as errorInvalidSlug, T as errorMigrationHashMismatch, _ as errorInvalidManifest, g as errorInvalidJson, k as errorProvidedInvariantsMismatch, m as errorInvalidDestName, t as MigrationToolsError, u as errorDirectoryExists } from "./errors-DD6iLGXk-B4Q4tIha.mjs";
import { r as verifyMigrationHash } from "./hash-BAZVWU4a-BdynTmar.mjs";
import { i as readContractSnapshotJsonTolerant } from "./contract-snapshot-store-1S_6vaGt-mzFobPtq.mjs";
...
//#region ../../../1-framework/3-tooling/migration/dist/io-xKnQrxIC.mjs
...
async function readMigrationPackage(dir, options) {
	...
	const endContractJson = await readContractSnapshotJsonTolerant(options.migrationsDir, metadata.to, options.verifySnapshotContent);
	const pkg = {
...
//# sourceMappingURL=io-xKnQrxIC-D_C_lwGm.mjs.map