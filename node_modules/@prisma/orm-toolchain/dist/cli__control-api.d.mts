import { o as PrismaNextConfig$1 } from "./index-D_KaEMoL.mjs";
...
import { n as SnapshotContentVerifier } from "./contract-snapshot-store-Bok5nQYi-D3g_P7im.mjs";
import "./contract-snapshot-store-DrIwu5pn.mjs";
...
interface ContractSourceFailure {
 ...
 * error emit raises.
 */
declare function loadContractSource(config: PrismaNextConfig, options?: {
 ...
 */
declare function enumerateCheckSpaces(aggregate: ContractSpaceAggregate, projectMigrationsDir: string, cwd: string, verifySnapshotContent?: SnapshotContentVerifier): Promise<readonly CheckSpace[]>;
/**
...
declare function loadAggregateIntegrityViolations(config: PrismaNextConfig$1, migrationsDir: string, verifySnapshotContent?: SnapshotContentVerifier): Promise<readonly IntegrityViolation[]>;
