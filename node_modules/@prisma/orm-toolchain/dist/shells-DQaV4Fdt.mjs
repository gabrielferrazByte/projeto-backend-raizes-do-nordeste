//#region ../../../0-shared/publish-surface/dist/shells.mjs
/**
...
*/
const COMMON_FACADE_REEXPORTS = [
	{
		package: "@internal/contract",
		entry: "contract"
	},
	{
		package: "@internal/framework-components",
		entry: "components"
	},
	{
...
function facadeReexports(options) {
	return [
		...
		{
			package: options.family,
			entry: "family-contract"
		},
		{
			package: options.familyPack,
			entry: "family",
			root: false
		},
		{
			package: options.runtime,
		...
		},
		{
			...
			entry: "target",
			root: false,
			...options.targetSubpaths === void 0 ? {} : { subpaths: options.targetSubpaths }
		},
		{
			package: options.adapter,
			entry: "adapter"
		},
		{
			package: options.driver,
			entry: "driver"
		},
...
*/
const SQL_QUERY_REEXPORTS = [
	{
		package: "@internal/sql-orm-client",
		entry: "orm-client"
	},
	{
		package: "@internal/sql-builder",
		entry: "builder"
	},
	{
		package: "@internal/sql-relational-core",
		entry: "relational-core"
	},
	{
		package: "@internal/sql-schema-ir",
		entry: "schema-ir",
		subpaths: ["types"]
	}
];
const publicShells = /* @__PURE__ */ new Map([
	["@prisma/orm-framework", {
		...
		packages: [
			...
			{
				dir: "packages/1-framework/1-core/config",
				name: "@internal/config",
				entry: "config"
			},
			{
				dir: "packages/1-framework/1-core/errors",
			...
			{
				dir: "packages/1-framework/2-authoring/ids",
				name: "@internal/ids",
				entry: "ids"
			},
			{
	...
	["@prisma/orm-family-sql", {
		...
		packages: [
			...
			{
				dir: "packages/2-sql/1-core/errors",
			...
			{
				dir: "packages/2-sql/5-runtime",
				name: "@internal/sql-runtime",
				entry: "runtime"
			},
			{
				dir: "packages/2-sql/9-family",
	...
	["@prisma/orm-postgres", {
		...
		kind: "facade",
		packages: [{
			dir: "packages/3-extensions/postgres",
	...
	["@prisma/orm-sqlite", {
		...
		kind: "facade",
		packages: [{
			dir: "packages/3-extensions/sqlite",
	...
	["@prisma/orm-mongo", {
		...
		kind: "facade",
		packages: [{
			dir: "packages/3-extensions/mongo",
			name: "@internal/mongo",
			entry: ""
		}],
		reexports: facadeReexports({
			...
			queryBuilders: [
				{
					package: "@internal/mongo-orm",
					entry: "orm"
				},
				{
					package: "@internal/mongo-query-builder",
					entry: "query-builder"
				},
				{
					package: "@internal/mongo-query-ast",
					entry: "query-ast"
				},
				{
					package: "@internal/mongo-value",
					entry: "value"
				}
			]
		})
	...
	["@prisma/orm-extension-postgis", {
		...
		kind: "extension",
		packages: [{
			dir: "packages/3-extensions/postgis",
...
const excludedSubpaths = [/^\.\/test(\/|$)/];
//#endregion
export { publicShells as n, excludedSubpaths as t };

//# sourceMappingURL=shells-DQaV4Fdt.mjs.map