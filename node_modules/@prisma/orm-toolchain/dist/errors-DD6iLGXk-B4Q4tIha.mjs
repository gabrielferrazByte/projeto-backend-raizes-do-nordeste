...
//#region ../../../1-framework/3-tooling/migration/dist/errors-DD6iLGXk.mjs
/**
...
function errorContractSnapshotContentMismatch(args) {
	const { storageHash, computedHash, jsonPath } = args;
	return new MigrationToolsError("MIGRATION.CONTRACT_SNAPSHOT_CONTENT_MISMATCH", "Contract snapshot content does not match its hash", {
...
//#endregion
export { errorRefNotResolvable as A, errorInvalidSpaceId as C, errorNoInvariantPath as D, errorMissingFile as E, errorUnknownInvariant as M, errorOperationsNotArray as O, errorInvalidSlug as S, errorMigrationHashMismatch as T, errorInvalidManifest as _, errorContractSnapshotHashMismatch as a, errorInvalidRefName as b, errorDescribeMissingEndContract as c, errorDuplicateInvariantInEdge as d, errorDuplicateSpaceId as f, errorInvalidJson as g, errorInvalidInvariantId as h, errorContractSnapshotContentMismatch as i, errorSpaceHeadRefMissing as j, errorProvidedInvariantsMismatch as k, errorDescriptorHeadHashMismatch as l, errorInvalidDestName as m, errorBundleNotFoundForGraphNode as n, errorContractSnapshotMissing as o, errorHashNotInGraph as p, errorContractDeserializationFailed as r, errorDescribeInvalidMetadata as s, MigrationToolsError as t, errorDirectoryExists as u, errorInvalidOperationEntry as v, errorMigrationContractViewMissing as w, errorInvalidRefValue as x, errorInvalidRefFile as y };

//# sourceMappingURL=errors-DD6iLGXk-B4Q4tIha.mjs.map