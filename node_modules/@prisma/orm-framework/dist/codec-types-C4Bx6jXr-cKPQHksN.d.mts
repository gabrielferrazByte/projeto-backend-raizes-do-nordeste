...
//#region ../../../1-framework/1-core/framework-components/dist/codec-types-C4Bx6jXr.d.mts
//#region src/shared/data-type.d.ts
/**
...
type DataTypeId = string & {
  readonly __dataTypeId: 'DataTypeId';
};
/**
 ...
 */
type Cast = (value: JsonValue) => JsonValue;
/**
...
declare function dataTypeId(id: string): DataTypeId;
/** Declare a data type. Every id it names, its own and each cast's source, is validated here. */
declare function dataType(id: string, spec: DataTypeSpec): DataType;
declare function createDataTypeLookup(types: readonly DataType[]): DataTypeLookup;
//#endregion
 ...
 */
interface CodecDescriptorTemplate<P = void> {
 ...
 */
interface CodecDescriptor<P = void> extends CodecDescriptorTemplate<P> {
 ...
 */
declare abstract class CodecDescriptorTemplateImpl<TParams = void> implements CodecDescriptorTemplate<TParams> {
 ...
 * template.
 */
declare abstract class CodecDescriptorImpl<TParams = void> extends CodecDescriptorTemplateImpl<TParams> implements CodecDescriptor<TParams> {
...
declare abstract class CodecImpl<Id extends string = string, TTraits extends readonly CodecTrait[] = readonly CodecTrait[], TWire = unknown, TInput = unknown> implements Codec<Id, TTraits, TWire, TInput> {
  readonly descriptor: CodecDescriptorTemplate<any>;
  /**
   ...
   */
  constructor(descriptor: CodecDescriptorTemplate<any>);
  get id(): Id;
...
//#endregion
export { dataTypeId as C, dataType as S, DataTypeId as _, CodecCallContext as a, ListCast as b, CodecDescriptorTemplate as c, CodecInstanceContext as d, CodecLookup as f, DataType as g, CodecTrait as h, Codec as i, CodecDescriptorTemplateImpl as l, CodecRegistry as m, AnyCodecDescriptorTemplate as n, CodecDescriptor as o, CodecRef as p, Cast as r, CodecDescriptorImpl as s, AnyCodecDescriptor as t, CodecImpl as u, DataTypeLookup as v, emptyCodecLookup as w, createDataTypeLookup as x, DataTypeSpec as y };
//# sourceMappingURL=codec-types-C4Bx6jXr-cKPQHksN.d.mts.map