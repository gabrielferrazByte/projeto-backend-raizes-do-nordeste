...
import { _ as DataTypeId, g as DataType, m as CodecRegistry, t as AnyCodecDescriptor, v as DataTypeLookup } from "./codec-types-C4Bx6jXr-cKPQHksN.mjs";
import { A as AuthoringTypeNamespace, L as ControlMutationDefaults, a as AuthoringContributions, d as AuthoringEntityTypeNamespace, o as AuthoringDataTypeEntry, p as AuthoringFieldNamespace, r as AuthoringAttributeSpecContributions, v as AuthoringModelAttributeDescriptorNamespace, w as AuthoringPslBlockDescriptorNamespace } from "./framework-authoring-C4qKf0lE-C6CUyzE5.mjs";
import { l as TypesImportSpec, t as AggregateDescriptor } from "./types-import-spec-B15QNHY_-CZajVHiF.mjs";
import { t as CapabilityMatrix } from "./capabilities-Cupq4-1--C71ORI3N.mjs";
import { a as ComponentMetadata, b as TargetInstance, c as DriverDescriptor, d as ExtensionDescriptor, f as ExtensionInstance, h as FamilyInstance, l as DriverInstance, m as FamilyDescriptor, n as AdapterInstance, t as AdapterDescriptor, v as TargetBoundComponentDescriptor, y as TargetDescriptor } from "./framework-components-By_tc8WO-DMUxsJ11.mjs";
import { r as ImportSpecifierResolver, t as EmissionSpi } from "./emission-types-ByNBI5Lx-u4GNPYIc.mjs";
import { m as PslDocumentAst } from "./psl-ast-CjS--vj2-DKxe-sf-.mjs";
...
declare function assembleDataTypes(descriptors: ReadonlyArray<Pick<ComponentMetadata, 'dataTypes'> & {
  readonly id?: string;
}>): {
...
declare function assembleAuthoringDataTypes(descriptors: ReadonlyArray<{
  readonly id?: string;
  readonly authoring?: AuthoringContributions;
 ...
 *    is never exercised.
 */
declare function enforceDataTypeInvariants(input: DataTypeInvariantInput): void;
...
declare function resolvePslBacktickEscapes(raw: string): string;
/** The escapes a TypeScript template tag resolves: the PSL two plus `\$`, the only way to write `${` in a template literal. */
declare function resolveTemplateTagEscapes(raw: string): string;
/**
...
//#endregion
export { SchemaDiff as $, storageHashHex as $t, MigrationPackage as A, assertUniqueCodecOwner as At, MigrationRunnerExecutionChecks as B, extractCodecLookup as Bt, EmitContractResult as C, VerifierOutcome as Ct, MigrationMetadata as D, assembleAuthoringDataTypes as Dt, MigratableTargetDescriptor as E, assembleAuthoringContributions as Et, MigrationPlannerConflict as F, createControlStack as Ft, MigrationRunnerSuccessValue as G, hasOperationPreview as Gt, MigrationRunnerPerSpaceOptions as H, extractComponentIds as Ht, MigrationPlannerFailureResult as I, describeTaggedLiteralFailure as It, OperationContext as J, hasSchemaView as Jt, MigrationScaffoldContext as K, hasPslContractInfer as Kt, MigrationPlannerResult as L, diffSchemas as Lt, MigrationPlanOperation as M, canonicalizeTaggedLiteralBody as Mt, MigrationPlanWithAuthoringSurface as N, contractSnapshotJsonSpecifier as Nt, MigrationOperationClass as O, assembleControlMutationDefaults as Ot, MigrationPlanner as P, contractSnapshotTypesSpecifier as Pt, PslContractInferCapable as Q, resolveTemplateTagEscapes as Qt, MigrationPlannerSuccessResult as R, dispositionForCategory as Rt, DiffableNode as S, VerifierIssueCategory as St, IntrospectSchemaResult as T, VerifyDatabaseSchemaResult as Tt, MigrationRunnerPerSpaceSuccessValue as U, extractQueryOperationTypeImports as Ut, MigrationRunnerFailure as V, extractCodecTypeImports as Vt, MigrationRunnerResult as W, hasMigrations as Wt, OperationPreviewCapable as X, orderIssuesByDependencies as Xt, OperationPreview as Y, issueOutcome as Yt, OperationPreviewStatement as Z, resolvePslBacktickEscapes as Zt, ControlTargetInstance as _, VERIFY_CODE_HASH_MISMATCH as _t, ContractSpace as a, SchemaTreeNode as at, DataTypeInvariantInput as b, VERIFY_CODE_TARGET_MISMATCH as bt, ControlAdapterInstance as c, SchemaVerifier as ct, ControlExtensionDescriptor as d, SchemaViewCapable as dt, SchemaDiffIssue as et, ControlExtensionInstance as f, SchemaViewNodeKind as ft, ControlTargetDescriptor as g, TargetMigrationsCapability as gt, ControlStack as h, TaggedLiteralCanonicalization as ht, ContractSerializer as i, SchemaSubjectClassifierCapable as it, MigrationPlan as j, buildExtensionLoadOrder as jt, MigrationOperationPolicy as k, assembleDataTypes as kt, ControlDriverDescriptor as l, SchemaVerifyOptions as lt, ControlFamilyInstance as m, TAGGED_LITERAL_MAX_BYTES as mt, AssembledAuthoringContributions as n, SchemaNodeRef as nt, ContractSpaceHeadRef as o, SchemaTreeNodeOptions as ot, ControlFamilyDescriptor as p, SignDatabaseResult as pt, OpFactoryCall as q, hasSchemaSubjectClassifier as qt, CONTRACT_SNAPSHOTS_DIRNAME as r, SchemaOwnership as rt, ControlAdapterDescriptor as s, SchemaTreeVisitor as st, APP_SPACE_ID as t, SchemaEntityCoordinate as tt, ControlDriverInstance as u, SchemaVerifyResult as ut, CoreSchemaView as v, VERIFY_CODE_MARKER_MISSING as vt, ExpectationFailureReason as w, VerifyDatabaseResult as wt, DiffSubjectGranularity as x, VerificationStatus as xt, CreateControlStackInput as y, VERIFY_CODE_SCHEMA_FAILURE as yt, MigrationRunner as z, enforceDataTypeInvariants as zt };
//# sourceMappingURL=control-daWTOzIt.d.mts.map