import { Tt as VerifyDatabaseSchemaResult, et as SchemaDiffIssue } from "./control-daWTOzIt.mjs";
import { i as NextAction, r as Diagnostic } from "./structured-error-Cc7AIRsp.mjs";
import { r as CliStructuredError } from "./control-DxiV2F-o-BYFWr0js.mjs";
...
declare const ERROR_CODE_CONSENT_PLAN_MISMATCH = "MIGRATION.CONSENT_PLAN_MISMATCH";
/**
 * An apply carrying consent was refused because the plan recomputed for it is
 * not the plan that was consented to.
 */
declare function errorConsentPlanMismatch(options: {
...
//# sourceMappingURL=execution-shS9XY88.d.mts.map