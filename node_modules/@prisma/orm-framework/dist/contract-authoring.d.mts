...
import { c as AuthoringEntityContext, d as AuthoringEntityTypeNamespace, l as AuthoringEntityTypeDescriptor } from "./framework-authoring-C4qKf0lE-C6CUyzE5.mjs";
import "./authoring-C3ci9IF_.mjs";
import { a as ColumnTypeDescriptor } from "./codec-BWgHuo8s.mjs";
...
type MergeExtensionAuthoringNamespaces<Extensions, Key extends AuthoringNamespaceKey, EmptyNamespace = Record<never, never>> = Extensions extends Record<string, unknown> ? keyof Extensions extends never ? EmptyNamespace : UnionToIntersection<{ [K in keyof Extensions]: ExtractAuthoringNamespaceFromPack<Extensions[K], Key, EmptyNamespace>; }[keyof Extensions]> : EmptyNamespace;
/**
...
//#endregion
//#region src/relation-nullability.d.ts
type ToOneRelationNullabilityContradiction = 'declared-optional' | 'declared-required';
type ToOneRelationNullability = {
 ...
 * value.
 */
declare function resolveToOneRelationNullable(input: {
...
type LocalFieldNullabilityLookup = (input: {
 ...
 */
declare function withDerivedToOneRelationNullability<TDomain extends ApplicationDomain>(domain: TDomain, localFieldNullability: LocalFieldNullabilityLookup): TDomain;
//#endregion
export { type AuthoringNamespaceKey, type BoundEnumType, type CapabilityMatrix, type CodecInput, type CodecTypeMap, ENUM_TYPE_HANDLE_BRAND, type EntityHelperFactoryOptions, type EntityHelperFunction, type EntityHelpersFromNamespace, type EnumMember, type EnumTypeHandle, type ExtractAuthoringNamespaceFromPack, type ForeignKeyDefaultsState, type IndexDef, type LocalFieldNullabilityLookup, type MergeExtensionAuthoringNamespaces, type ToOneRelationNullability, type ToOneRelationNullabilityContradiction, type UnionToIntersection, bindEnumType, createEntityHelpersFromNamespace, enumType, isEnumTypeHandle, member, mergeCapabilityMatrices, resolveToOneRelationNullable, withDerivedToOneRelationNullability };
//# sourceMappingURL=contract-authoring.d.mts.map