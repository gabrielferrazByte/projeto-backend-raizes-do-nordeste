...
//#region ../../../1-framework/2-authoring/psl-parser/dist/tokenizer-CFsbtfFw.mjs
var Tokenizer = class {
	#source;
	#pos;
	#buffer;
	...
	peek(offset = 0) {
		...
		return blindCast(this.#buffer[offset]);
	}
	#scanNext() {
...
//# sourceMappingURL=tokenizer-CFsbtfFw-BnfUBepb.mjs.map