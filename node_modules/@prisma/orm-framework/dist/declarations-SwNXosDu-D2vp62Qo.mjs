import { F as resolvePslBacktickEscapes, g as canonicalizeTaggedLiteralBody } from "./control-0Teuhk1e.mjs";
import { n as isTerminatedStringLiteral } from "./tokenizer-CFsbtfFw-BnfUBepb.mjs";
//#region ../../../1-framework/2-authoring/psl-parser/dist/declarations-SwNXosDu.mjs
/**
...
var SyntaxNode = class SyntaxNode {
	...
	*childNodes() {
	...
	root() {
		let current = this;
		for (const parent of this.ancestors()) current = parent;
		return current;
	}
	*ancestors() {
...
//#endregion
export { createSyntaxTree as A, SyntaxToken as C, TypesBlockAst as D, TypeAnnotationAst as E, findChildToken as M, findFirstChild as N, any as O, printSyntax as P, SyntaxNode as S, TokenAtOffset as T, NumberLiteralExprAst as _, CompositeTypeDeclarationAst as a, QualifiedNameAst as b, FieldDeclarationAst as c, IdentifierAst as d, KeyValuePairAst as f, NamespaceDeclarationAst as g, NamedTypeDeclarationAst as h, BooleanLiteralExprAst as i, filterChildren as j, castExpression as k, FunctionCallAst as l, ModelDeclarationAst as m, AttributeArgAst as n, DocumentAst as o, ModelAttributeAst as p, AttributeArgListAst as r, FieldAttributeAst as s, ArrayLiteralAst as t, GenericBlockDeclarationAst as u, ObjectFieldAst as v, TaggedLiteralExprAst as w, StringLiteralExprAst as x, ObjectLiteralExprAst as y };

//# sourceMappingURL=declarations-SwNXosDu-D2vp62Qo.mjs.map