import { V as JsonValue, nt as ValueSetRef } from "./domain-envelope-CENjHN4U-BIIt9bl4.mjs";
import { c as CodecDescriptorTemplate, d as CodecInstanceContext, i as Codec, p as CodecRef, t as AnyCodecDescriptor } from "./codec-types-C4Bx6jXr-cKPQHksN.mjs";
 ...
 */
type ColumnHelperFor<D extends CodecDescriptorTemplate<any>> = (...args: any[]) => ColumnSpec<unknown, ColumnHelperParams<D>>;
/**
 ...
 */
type ColumnHelperForStrict<D extends CodecDescriptorTemplate<any>> = (...args: any[]) => ColumnSpec<ReturnType<ReturnType<D['factory']>>, ColumnHelperParams<D>>;
/**
 ...
 */
type ColumnHelperParams<D extends CodecDescriptorTemplate<any>> = Parameters<D['factory']>[0] extends Record<string, unknown> ? Parameters<D['factory']>[0] : undefined;
//#endregion
...
//# sourceMappingURL=codec-BWgHuo8s.d.mts.map