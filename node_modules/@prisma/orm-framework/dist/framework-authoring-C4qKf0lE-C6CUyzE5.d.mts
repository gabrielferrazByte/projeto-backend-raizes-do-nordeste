import { F as ExecutionMutationDefaultValue, P as ExecutionMutationDefaultPhases, V as JsonValue, a as ColumnDefault } from "./domain-envelope-CENjHN4U-BIIt9bl4.mjs";
import { _ as DataTypeId, f as CodecLookup } from "./codec-types-C4Bx6jXr-cKPQHksN.mjs";
import { Type } from "arktype";
//#region ../../../1-framework/1-core/framework-components/dist/framework-authoring-C4qKf0lE.d.mts
 ...
 */
interface ControlDefaultRegistries extends Pick<ControlMutationDefaults, 'defaultFunctionRegistry'> {
 ...
 */
'PSL_INVALID_EXTENSION_BLOCK_ATTRIBUTE' | 'PSL_EXTENSION_UNKNOWN_BLOCK_ATTRIBUTE' |
/**
...
interface PslExtensionBlockParsedAttribute {
  readonly args: Readonly<Record<string, unknown>>;
  readonly span: PslSpan;
}
/**
 ...
 */
interface AuthoringModelAttributeEntityOutput {
  readonly key: string;
 ...
 */
interface AuthoringModelAttributeIndexOutput {
 ...
 */
type AuthoringModelAttributeLoweringOutput = AuthoringModelAttributeEntityOutput | AuthoringModelAttributeIndexOutput;
/**
...
interface AuthoringAttributeSpecContributions {
 ...
 */
interface DataTypeLoweringAuthoringEntry {
  readonly written: {
    readonly kind: 'tag';
    readonly tag: string;
  };
...
type AuthoringDataTypeEntry = DataTypeAuthoringEntry | DataTypeLoweringAuthoringEntry;
/**
 * The key a lowering entry sits under. A data type id is `owner/name`, so a key carrying this
 * prefix can never collide with one.
 */
declare function loweringEntryKey(tag: string): string;
declare function isLoweringEntryKey(key: string): boolean;
/** Which of the two kinds of entry this is; the only place the discriminating key is named. */
declare function isDataTypeLoweringEntry(entry: AuthoringDataTypeEntry): entry is DataTypeLoweringAuthoringEntry;
...
//#endregion
export { PslExtensionBlockAttributeArg as $, AuthoringTypeNamespace as A, isLoweringEntryKey as At, DataTypeWrittenForm as B, AuthoringPslBlockDescriptor as C, isAuthoringArgRef as Ct, AuthoringTemplateValue as D, isAuthoringPslBlockDescriptor as Dt, AuthoringStorageTypeTemplate as E, isAuthoringModelAttributeDescriptor as Et, ControlMutationDefaultEntry as F, validateAuthoringHelperArguments as Ft, PslBlockParam as G, LoweredDefaultResult as H, ControlMutationDefaultRegistry as I, PslBlockParamRef as J, PslBlockParamList as K, ControlMutationDefaults as L, AuthoringWarningSink as M, mergeAuthoringNamespaces as Mt, ContributedPslDiagnosticCode as N, resolveAuthoringTemplateValue as Nt, AuthoringTypeConstructorDescriptor as O, isAuthoringTypeConstructorDescriptor as Ot, ControlDefaultRegistries as P, resolveEnumCodecId as Pt, PslExtensionBlockAttribute as Q, DataTypeAuthoringEntry as R, AuthoringOption as S, instantiateAuthoringTypeConstructor as St, AuthoringSelectRef as T, isAuthoringFieldPresetDescriptor as Tt, LoweredDefaultValue as U, DefaultFunctionLoweringContext as V, MutationDefaultGeneratorDescriptor as W, PslDiagnosticCode as X, PslBlockParamValue as Y, PslExtensionBlock as Z, AuthoringModelAttributeDescriptor as _, collectScalarTypeConstructors as _t, AuthoringContributions as a, PslExtensionBlockParamValue as at, AuthoringModelAttributeIndexOutput as b, instantiateAuthoringEntityType as bt, AuthoringEntityContext as c, PslSpan as ct, AuthoringEntityTypeNamespace as d, SourceSpan as dt, PslExtensionBlockParamBare as et, AuthoringEntityTypeTemplateOutput as f, TaggedLiteralValue as ft, AuthoringModelAttributeContext as g, classifyEnumMemberType as gt, AuthoringFieldPresetOutput as h, assertResolvableTypeConstructorTemplates as ht, AuthoringColumnDefaultTemplate as i, PslExtensionBlockParamScalarValue as it, AuthoringWarning as j, loweringEntryKey as jt, AuthoringTypeConstructorEntityRef as k, isDataTypeLoweringEntry as kt, AuthoringEntityTypeDescriptor as l, ScalarTypeConstructorOutput as lt, AuthoringFieldPresetDescriptor as m, assertNoCrossRegistryCollisions as mt, AuthoringArgumentDescriptor as n, PslExtensionBlockParamOption as nt, AuthoringDataTypeEntry as o, PslExtensionBlockParsedAttribute as ot, AuthoringFieldNamespace as p, TypedDefaultFunctionCall as pt, PslBlockParamOption as q, AuthoringAttributeSpecContributions as r, PslExtensionBlockParamRef as rt, AuthoringDiagnosticSink as s, PslPosition as st, AuthoringArgRef as t, PslExtensionBlockParamList as tt, AuthoringEntityTypeFactoryOutput as u, SourceDiagnostic as ut, AuthoringModelAttributeDescriptorNamespace as v, flushAuthoringWarnings as vt, AuthoringPslBlockDescriptorNamespace as w, isAuthoringEntityTypeDescriptor as wt, AuthoringModelAttributeLoweringOutput as x, instantiateAuthoringFieldPreset as xt, AuthoringModelAttributeEntityOutput as y, hasRegisteredFieldNamespace as yt, DataTypeLoweringAuthoringEntry as z };
//# sourceMappingURL=framework-authoring-C4qKf0lE-C6CUyzE5.d.mts.map