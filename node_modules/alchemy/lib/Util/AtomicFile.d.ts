 ...
 */
export declare const writeFileAtomic: (fs: FileSystem.FileSystem, filePath: string, contents: string, mode?: number) => Effect.Effect<void, PlatformError>;
//# sourceMappingURL=AtomicFile.d.ts.map