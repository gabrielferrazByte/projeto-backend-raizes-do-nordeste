...
export declare const zipCode: (content: string | Uint8Array<ArrayBufferLike>, files?: readonly ZipFile[] | undefined) => Effect.Effect<any, never, never>;
/**
 ...
 * identical bytes.
 */
export declare const zipFiles: (files: readonly ZipFile[]) => Effect.Effect<any, never, never>;
