...
const compactFlagType = (type) => {
    if (type === "boolean" || type.length <= 24)
        return type;
 ...
 */
const wrapLines = (text, width) => text
    .split("\n")
    .flatMap((line) => {
...
//# sourceMappingURL=PlainCliFormatter.js.map