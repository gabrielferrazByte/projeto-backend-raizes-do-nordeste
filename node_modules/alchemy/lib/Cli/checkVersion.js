...
import { ANSI_RESET, ansiFg, colorsEnabled, glyphsFor, theme, unicodeEnabled, } from "./CliKit/index.js";
...
export const checkLatestVersion = Effect.gen(function* () {
    ...
    if (latest === undefined || compareVersions(latest, current) <= 0)
        return;
    const installCmd = typeof process !== "undefined" && process.versions.bun !== undefined
