...
import { configPath, envFile, force, devStage, optionalConfig, profile, resolveStackArgs, } from "./flags.js";
import { suppressInterruptMessages } from "./errors.js";
...
export const devCommand = Command.make("dev", {
    ...
    if (typeof globalThis.Bun !== "undefined") {
        ...
        const entry = fileURLToPath(import.meta.resolve(`alchemy/bin/exec${moduleExtension(import.meta.url)}`));
        command = [
            process.execPath,
            ...process.execArgv,
    ...
    const runChild = ChildProcess.make(command[0], command.slice(1), {
        ...
        detached: false,
    }).pipe(Effect.flatMap((child) => child.exitCode), Effect.scoped);
...
}))(effect))).pipe(Command.withDescription("Develop a stack with live reload"));
