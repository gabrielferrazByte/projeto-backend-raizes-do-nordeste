...
export type { AwaitExternalOptions, Choice, ConfirmOptions, InteractionError, MessageOptions, MultiSelectOptions, PasswordInputOptions, ProgressOptions, SelectOptions, TextInputOptions, } from "../../Interaction.ts";
...
export declare const Screen: {
    make: <Value>(name: string, render: (controller: ScreenController<Value>) => View) => Screen<Value>;
};
/**
