...
export const isRailwayTransient = (error) => railway.isErrorTag(error, [
    "RailwayRateLimited",
 ...
 */
export const waitOutCreateRateLimit = (effect) => Semaphore.withPermits(projectAndEnvironmentCreateGate, 1)(effect.pipe(Effect.retry({
 ...
 */
const environmentConfigGates = new Map();
export const withEnvironmentConfigLock = (environmentId, effect) => {
