 ...
 * @binding
 */
export interface WriteRedis extends Binding.Service<WriteRedis, "Railway.WriteRedis", (redis: Redis) => Effect.Effect<WriteRedisClient>> {
}
export declare const WriteRedis: WriteRedis;
export type WriteRedisClient = WriteClient;
//# sourceMappingURL=WriteRedis.d.ts.map