 ...
 * ```
 */
export type InferEnv<F> = F extends Effect.Effect<infer A, infer _E, infer _R> ? InferEnv<A> : F extends {
    readonly Props: {
        readonly env?: infer E;
    };
} ? InferEnvRecord<Exclude<E, undefined>> : InferEnvRecord<F>;
