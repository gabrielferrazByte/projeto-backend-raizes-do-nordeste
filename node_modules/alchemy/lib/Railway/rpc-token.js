...
const envKey = (logicalId, suffix) => `RAILWAY_RPC_${logicalId.replaceAll(/[^a-zA-Z0-9]/g, "_").toUpperCase()}_${suffix}`;
export const rpcEnvKeys = (logicalId) => ({
 ...
 */
export const mintRpcToken = (logicalId) => makeRandom(`${logicalId}RpcToken`);
//# sourceMappingURL=rpc-token.js.map