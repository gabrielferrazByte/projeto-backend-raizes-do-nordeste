 ...
 */
export declare const SPILL_PART_BYTES: number;
/**
 ...
 */
export declare const feedBody: (body: ReadableStream<Uint8Array> | null, feeder: StreamingFeeder) => Effect.Effect<{
    readonly total: number;
}, StoreError>;
//# sourceMappingURL=IncomingBody.d.ts.map