 ...
 */
export const objectKey = (repoId, oid) => `${repoId}/objects/${oid}`;
/**
 ...
 */
export const packKey = (repoId, sha) => `${repoId}/packs/pack-${sha}.pack`;
/**
 ...
 */
export const bundleKey = (repoId, refsHash) => `${repoId}/bundles/bundle-${refsHash}.pack`;
/**
 ...
 */
export const bundleSidebandKey = (repoId, refsHash) => `${repoId}/bundles/bundle-${refsHash}.sideband`;
/**
 ...
 * buffered ingest.
 */
export const incomingKey = (repoId, pushId) => `${repoId}/incoming/${pushId}.pack`;
/**
...
export const wirePackId = (receiveId) => `${WIRE_PACK_PREFIX}${receiveId}`;
export const isWirePackId = (packId) => packId.startsWith(WIRE_PACK_PREFIX);
/** R2 key of any pack by id — compacted (`packKey`) or promoted wire pack. */
export const packKeyOf = (repoId, packId) => isWirePackId(packId)
 ...
 * `{repoId}/lfs/{sha256}`.
 */
export const lfsKey = (repoId, sha256) => `${repoId}/lfs/${sha256}`;
/**
 ...
 */
export const headKey = (repoId) => `${repoId}/head`;
