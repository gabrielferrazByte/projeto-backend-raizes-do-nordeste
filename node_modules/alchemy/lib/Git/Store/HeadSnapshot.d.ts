...
export declare const encodeHeadSnapshot: (snapshot: HeadSnapshot) => string;
/** `undefined` on malformed/foreign content — callers fall to the DO. */
export declare const decodeHeadSnapshot: (raw: string) => HeadSnapshot | undefined;
//# sourceMappingURL=HeadSnapshot.d.ts.map