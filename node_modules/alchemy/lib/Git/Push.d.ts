...
export interface IncomingState {
    ...
    readonly receiving: Fiber.Fiber<Result.Result<{
...
/** @internal */
export declare const incomingStates: WeakMap<PushInput, IncomingState>;
...
export interface PreparedPush {
    ...
    readonly readObject: (oid: string, maxBytes?: number) => Effect.Effect<{
        readonly type: ObjectType;
        readonly content: Uint8Array;
    } | undefined, StoreError, RuntimeContext>;
}
/** @internal */
export declare const preparedStates: WeakMap<PreparedPush, {
...
export declare const invalidPush: () => StoreError;
