 ...
 */
import { RepoPath, RepoNotFound, PushDenied } from "./Schema.js";
import * as HttpApiEndpoint from "effect/unstable/httpapi/HttpApiEndpoint";
import * as HttpApiGroup from "effect/unstable/httpapi/HttpApiGroup";
/** `GET /:owner/:repo/info/refs?service=…`: the ref advertisement. */
export const InfoRefs = HttpApiEndpoint.get("infoRefs", "/:owner/:repo/info/refs", { params: RepoPath, error: [RepoNotFound, PushDenied] });
/** `POST /:owner/:repo/git-upload-pack`: clone and fetch. */
export const UploadPack = HttpApiEndpoint.post("uploadPack", "/:owner/:repo/git-upload-pack", { params: RepoPath, error: [RepoNotFound, PushDenied] });
/** `POST /:owner/:repo/git-receive-pack`: push. */
export const ReceivePack = HttpApiEndpoint.post("receivePack", "/:owner/:repo/git-receive-pack", { params: RepoPath, error: [RepoNotFound, PushDenied] });
