...
export const GitHubUpdatePull = HttpApiEndpoint.patch("updatePull", "/repos/:owner/:repo/pulls/:number", {});
/** `PUT /repos/:owner/:repo/pulls/:number/merge` */
export const GitHubMergePull = HttpApiEndpoint.put("mergePull", "/repos/:owner/:repo/pulls/:number/merge", {});
/** `GET /repos/:owner/:repo/pulls/:number/files` */
export const GitHubPullFiles = HttpApiEndpoint.get("pullFiles", "/repos/:owner/:repo/pulls/:number/files", {});
/** The GitHub facade, mounted at `/api/v3`. */
export class GitHub extends HttpApiGroup.make("github")
    .add(GitHubUser, GitHubRepo, GitHubBranches, GitHubCommits, GitHubCommit, GitHubContents, GitHubPulls, GitHubCreatePull, GitHubPull, GitHubUpdatePull, GitHubMergePull, GitHubPullFiles)
    .prefix("/api/v3") {
}
