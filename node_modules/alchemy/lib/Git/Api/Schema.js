 ...
 */
export const Oid = Schema.String.check(Schema.isPattern(/^[0-9a-f]{40}$/)).pipe(Schema.brand("Oid"));
/**
 ...
 */
export const RepoName = Schema.String.check(Schema.isPattern(/^[a-z0-9](?:[a-z0-9._-]{0,98}[a-z0-9])?$/i));
/**
...
export class ReadOnlyRepo extends Schema.TaggedError()("ReadOnlyRepo", {}, { httpApiStatus: 403 }) {
}
/** 403 — application policy refused a proposed ref update. */
export class PushDenied extends Schema.TaggedError()("PushDenied", { ref: Schema.String, reason: Schema.String }, { httpApiStatus: 403 }) {
}
/** 404 — no repo at `owner/repo` (or it finished deleting). */
export class RepoNotFound extends Schema.TaggedError()("RepoNotFound", { owner: Schema.String, repo: Schema.String }, { httpApiStatus: 404 }) {
}
/** 409 — a repo already exists at `owner/repo`. */
export class RepoAlreadyExists extends Schema.TaggedError()("RepoAlreadyExists", { owner: Schema.String, repo: Schema.String }, { httpApiStatus: 409 }) {
}
/**
 * 409 — the repo exists but is not `ready` (importing / forking /
 * deleting); retry after polling `GET /repos/:owner/:repo`.
 */
export class RepoNotReady extends Schema.TaggedError()("RepoNotReady", { status: RepoStatus }, { httpApiStatus: 409 }) {
}
/** 404 — the named ref does not exist. */
export class RefNotFound extends Schema.TaggedError()("RefNotFound", { ref: Schema.String }, { httpApiStatus: 404 }) {
}
/**
 ...
 * not exist).
 */
export class RefConflict extends Schema.TaggedError()("RefConflict", { ref: Schema.String, currentOid: Schema.NullOr(Oid) }, { httpApiStatus: 409 }) {
}
/** 404 — no object with the given oid in this repo. */
export class ObjectNotFound extends Schema.TaggedError()("ObjectNotFound", { oid: Schema.String }, { httpApiStatus: 404 }) {
}
/** 422 — the object exists but has a different type than the endpoint expects. */
export class WrongObjectType extends Schema.TaggedError()("WrongObjectType", { oid: Schema.String, expected: Schema.String, actual: Schema.String }, { httpApiStatus: 422 }) {
}
/**
 * 422 — the blob is too large for the base64 JSON endpoint (> 1 MiB);
 * use the raw streaming route `GET .../blobs/:oid/raw` instead.
 */
export class ObjectTooLarge extends Schema.TaggedError()("ObjectTooLarge", { oid: Schema.String, size: Schema.Number }, { httpApiStatus: 422 }) {
}
/**
 ...
 */
export class NoMergeBase extends Schema.TaggedError()("NoMergeBase", { base: Oid, head: Oid }, { httpApiStatus: 422 }) {
}
/** 502 — the async import job failed against the source remote. */
export class ImportFailed extends Schema.TaggedError()("ImportFailed", { reason: Schema.String }, { httpApiStatus: 502 }) {
}
/** 400 — semantically invalid request (e.g. reserved owner name). */
export class ValidationError extends Schema.TaggedError()("ValidationError", { message: Schema.String }, { httpApiStatus: 400 }) {
}
/** 404 — no pull request with this number. */
export class PullNotFound extends Schema.TaggedError()("PullNotFound", { number: Schema.Number }, { httpApiStatus: 404 }) {
}
/** 422 — the PR's base or head branch does not exist (deleted after open). */
export class BranchMissing extends Schema.TaggedError()("BranchMissing", { ref: Schema.String }, { httpApiStatus: 422 }) {
}
/** 409 — an open PR for this base/head pair already exists. */
export class PullExists extends Schema.TaggedError()("PullExists", { number: Schema.Number }, { httpApiStatus: 409 }) {
}
/**
...
export class NothingToMerge extends Schema.TaggedError()("NothingToMerge", { number: Schema.Number }, { httpApiStatus: 422 }) {
}
/**
 ...
 */
export class ObjectStats extends Schema.Class("ObjectStats")({
 ...
 */
export class PushStats extends Schema.Class("PushStats")({
...
export class Repo extends Schema.Class("Repo")({
 ...
 */
export class Ref extends Schema.Class("Ref")({
...
export class CommitInfo extends Schema.Class("CommitInfo")({
    oid: Oid,
...
export class TreeEntry extends Schema.Class("TreeEntry")({
 ...
 * fetch them as blobs.
 */
export class DiffEntry extends Schema.Class("DiffEntry")({
...
export class CommitDiff extends Schema.Class("CommitDiff")({
    oid: Oid,
...
export class Comparison extends Schema.Class("Comparison")({
 ...
 */
export class Pull extends Schema.Class("Pull")({
 ...
 */
export class PullDetail extends Pull.extend("PullDetail")({
...
export class MergeResult extends Schema.Class("MergeResult")({
 ...
 * round trip.
 */
export class RepoCreated extends Schema.Class("RepoCreated")({
    repo: Repo,
 ...
 * ```
 */
export const Paginated = (items) => Schema.Struct({
