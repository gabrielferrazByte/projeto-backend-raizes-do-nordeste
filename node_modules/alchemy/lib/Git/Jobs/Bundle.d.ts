 ...
 */
export declare const hashRefs: (refs: ReadonlyArray<BundleRef>) => string;
/**
 ...
 * buffering.
 */
export declare const packByteLength: (entries: ReadonlyArray<ManifestEntry>) => number;
...
export interface BundleJobOptions {
    ...
    readonly packStream: (entries: ReadonlyArray<ManifestEntry>) => Stream.Stream<Uint8Array, StoreError>;
 ...
 */
export declare const runBundleJob: (options: BundleJobOptions) => Effect.Effect<BundleInfo | undefined, StoreError>;
/**
 ...
 */
export declare const bundleCovers: (bundle: BundleInfo, request: {
 ...
 */
export declare const bundleUncovered: (bundle: BundleInfo, request: {
    readonly wants: ReadonlyArray<Oid>;
    readonly haves: ReadonlyArray<Oid>;
    readonly depth?: number | undefined;
    readonly clientShallow: ReadonlyArray<Oid>;
