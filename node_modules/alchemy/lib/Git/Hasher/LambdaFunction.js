...
import * as Lambda from "../../AWS/Lambda/Function.js";
import { handleHashEvent, isHashEvent } from "./LambdaEvent.js";
export default class HasherFunction extends Lambda.Function()("GitHasher", {
    ...
    yield* fn.listen((event) => isHashEvent(event) ? handleHashEvent(event) : undefined);
    return {};
})) {
}
