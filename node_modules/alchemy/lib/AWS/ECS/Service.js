...
export const ServiceProvider = () => Provider.effect(Service, Effect.gen(function* () {
    ...
    return {
        ...
        delete: Effect.fn(function* ({ output, session }) {
            ...
            Effect.catchTag("ServiceNotActiveException", () => Effect.void), Effect.catchTag("ServiceNotFoundException", () => Effect.void), Effect.catchTag("ClusterNotFoundException", () => Effect.void));
