...
export declare const isTask: (value: any) => value is Task;
declare const TaskEnvironment_base: Context.ServiceClass<TaskEnvironment, "AWS.ECS.TaskEnvironment", Record<string, any>>;
export declare class TaskEnvironment extends TaskEnvironment_base {
}
/**
...
export interface TaskDefinitionConfig {
     ...
     */
    taskDefinition?: Partial<Omit<ecs.RegisterTaskDefinitionRequest, "family" | "containerDefinitions" | "executionRoleArn" | "taskRoleArn" | "cpu" | "memory">>;
    /**
...
export interface Task extends Resource<"AWS.ECS.Task", TaskProps, {
 ...
 */
export type TaskShape = void | (Exclude<Main<TaskServices>, void> & {
    /**
 ...
 * @resource
 */
export declare const Task: Platform<Task, TaskServices, TaskShape, TaskRuntimeContext>;
/** Docker build platform matching the task definition's declared runtime. */
export declare const taskImagePlatform: (runtimePlatform?: ecs.RuntimePlatform) => "linux/amd64" | "linux/arm64";
/**
 ...
 */
export declare const createTaskRoleIfNotExists: (args_0: {
    id: string;
    roleName: string;
}) => Effect.Effect<string, Error | import("effect/unstable/http/HttpClientError").HttpClientError | import("effect/PlatformError").PlatformError, Credentials | import("effect/unstable/http/HttpClient").HttpClient | Stack | import("../../Stage.ts").Stage>;
/**
 * Ensure the ECS execution role exists with the standard execution policy
 * (plus any additional managed policies) attached.
 */
export declare const ensureTaskExecutionRole: (args_0: {
    id: string;
    roleName: string;
 ...
 */
export declare const syncEnvironmentFilesPolicy: (args_0: {
    roleName: string;
    environmentFiles: ecs.EnvironmentFile[] | undefined;
}) => Effect.Effect<void, import("@distilled.cloud/aws/Errors").AccessDeniedException | import("@distilled.cloud/aws/Credentials").AwsCredentialProviderError | import("@distilled.cloud/aws/Credentials").ConflictingSSORegion | import("@distilled.cloud/aws/Credentials").ConflictingSSOStartUrl | import("@distilled.cloud/aws/SigV4").CryptoError | import("@distilled.cloud/aws/Errors").EndpointError | import("@distilled.cloud/aws/Credentials").ExpiredSSOToken | import("@distilled.cloud/aws/Errors").ExpiredTokenException | import("effect/unstable/http/HttpClientError").HttpClientError | import("@distilled.cloud/aws/Errors").IncompleteSignature | import("@distilled.cloud/aws/Errors").InternalFailure | import("@distilled.cloud/aws/Credentials").InvalidSSOProfile | import("@distilled.cloud/aws/Credentials").InvalidSSOToken | import("@distilled.cloud/aws/SigV4").InvalidSigningHeaders | import("@distilled.cloud/aws/SigV4").InvalidSigningUrl | iam.LimitExceededException | import("@distilled.cloud/aws/Errors").MalformedHttpRequestException | iam.MalformedPolicyDocumentException | import("@distilled.cloud/aws/Credentials").MissingRegion | import("@distilled.cloud/aws/Errors").NoMatchingRuleError | iam.NoSuchEntityException | import("@distilled.cloud/aws/Errors").NotAuthorized | import("@distilled.cloud/aws/Errors").OperationAborted | import("@distilled.cloud/aws/Errors").OptInRequired | import("effect/PlatformError").PlatformError | import("@distilled.cloud/aws/Credentials").ProfileNotFound | import("@distilled.cloud/aws/Errors").RequestAbortedException | import("@distilled.cloud/aws/Errors").RequestEntityTooLargeException | import("@distilled.cloud/aws/Errors").RequestExpired | import("@distilled.cloud/aws/Errors").RequestTimeoutException | iam.ServiceFailureException | import("@distilled.cloud/aws/Errors").ServiceUnavailable | import("@distilled.cloud/aws/Credentials").SsoPortalError | import("@distilled.cloud/aws/Errors").ThrottlingException | import("@distilled.cloud/aws/Errors").UnknownAwsError | import("@distilled.cloud/aws/Errors").UnknownOperationException | iam.UnmodifiableEntityException | import("@distilled.cloud/aws/Errors").UnrecognizedClientException | import("@distilled.cloud/aws/Errors").ValidationError | import("@distilled.cloud/aws/Errors").ValidationException, Credentials | import("effect/unstable/http/HttpClient").HttpClient>;
/** Ensure the CloudWatch log group the task writes to exists. */
export declare const ensureTaskLogGroup: (args_0: {
    id: string;
    logGroupName: string;
}) => Effect.Effect<string, logs.InvalidParameterException | logs.LimitExceededException | logs.OperationAbortedException | logs.ServiceUnavailableException | import("@distilled.cloud/aws/Errors").CommonErrors, AWSEnvironment | Credentials | import("effect/unstable/http/HttpClient").HttpClient | Stack | import("../../Stage.ts").Stage>;
/**
 ...
 */
export declare const attachTaskBindings: (args_0: {
    roleName: string;
    policyName: string;
    ...
    volumes: ecs.Volume[];
    mountPoints: ecs.MountPoint[];
}, import("@distilled.cloud/aws/Errors").AccessDeniedException | import("@distilled.cloud/aws/Credentials").AwsCredentialProviderError | import("@distilled.cloud/aws/Credentials").ConflictingSSORegion | import("@distilled.cloud/aws/Credentials").ConflictingSSOStartUrl | import("@distilled.cloud/aws/SigV4").CryptoError | import("@distilled.cloud/aws/Errors").EndpointError | import("@distilled.cloud/aws/Credentials").ExpiredSSOToken | import("@distilled.cloud/aws/Errors").ExpiredTokenException | import("effect/unstable/http/HttpClientError").HttpClientError | import("@distilled.cloud/aws/Errors").IncompleteSignature | import("@distilled.cloud/aws/Errors").InternalFailure | import("@distilled.cloud/aws/Credentials").InvalidSSOProfile | import("@distilled.cloud/aws/Credentials").InvalidSSOToken | import("@distilled.cloud/aws/SigV4").InvalidSigningHeaders | import("@distilled.cloud/aws/SigV4").InvalidSigningUrl | iam.LimitExceededException | import("@distilled.cloud/aws/Errors").MalformedHttpRequestException | iam.MalformedPolicyDocumentException | import("@distilled.cloud/aws/Credentials").MissingRegion | import("@distilled.cloud/aws/Errors").NoMatchingRuleError | iam.NoSuchEntityException | import("@distilled.cloud/aws/Errors").NotAuthorized | import("@distilled.cloud/aws/Errors").OperationAborted | import("@distilled.cloud/aws/Errors").OptInRequired | import("effect/PlatformError").PlatformError | import("@distilled.cloud/aws/Credentials").ProfileNotFound | import("@distilled.cloud/aws/Errors").RequestAbortedException | import("@distilled.cloud/aws/Errors").RequestEntityTooLargeException | import("@distilled.cloud/aws/Errors").RequestExpired | import("@distilled.cloud/aws/Errors").RequestTimeoutException | iam.ServiceFailureException | import("@distilled.cloud/aws/Errors").ServiceUnavailable | import("@distilled.cloud/aws/Credentials").SsoPortalError | import("@distilled.cloud/aws/Errors").ThrottlingException | import("@distilled.cloud/aws/Errors").UnknownAwsError | import("@distilled.cloud/aws/Errors").UnknownOperationException | iam.UnmodifiableEntityException | import("@distilled.cloud/aws/Errors").UnrecognizedClientException | import("@distilled.cloud/aws/Errors").ValidationError | import("@distilled.cloud/aws/Errors").ValidationException, Credentials | import("effect/unstable/http/HttpClient").HttpClient>;
/**
 * Register a new task definition revision from the shared
 * {@link TaskDefinitionConfig} surface.
 */
export declare const registerTaskDefinitionRevision: (args_0: {
...
}) => Effect.Effect<ecs.TaskDefinition, ecs.RegisterTaskDefinitionError, AWSEnvironment | Credentials | import("effect/unstable/http/HttpClient").HttpClient>;
/**
 * Sync tags on a task definition revision: diff observed revision tags
 * against desired and apply the delta.
 */
export declare const syncTaskDefinitionTags: (args_0: {
    revisionArn: string;
    tags: Record<string, string>;
}) => Effect.Effect<void, ecs.TagResourceError, Credentials | import("effect/unstable/http/HttpClient").HttpClient>;
/**
 ...
 * finishes the delete.
 */
export declare const reapSupersededTaskDefinitionRevision: (args_0: {
    ...
    nextArn: string;
}) => Effect.Effect<void, ecs.AccessDeniedException | ecs.InvalidParameterException | ecs.ServerException | import("@distilled.cloud/aws/Errors").CommonErrors, Credentials | import("effect/unstable/http/HttpClient").HttpClient>;
/**
 ...
 * "already gone".
 */
export declare const deleteTaskDefinitionInfrastructure: (output: {
    taskDefinitionArn: string;
    /**
    ...
    taskRoleName: string;
    executionRoleName: string;
}) => Effect.Effect<void, import("@distilled.cloud/aws/Errors").AccessDeniedException | ecs.AccessDeniedException | import("@distilled.cloud/aws/Credentials").AwsCredentialProviderError | ecs.ClientException | iam.ConcurrentModificationException | import("@distilled.cloud/aws/Credentials").ConflictingSSORegion | import("@distilled.cloud/aws/Credentials").ConflictingSSOStartUrl | import("@distilled.cloud/aws/SigV4").CryptoError | iam.DeleteConflictException | import("@distilled.cloud/aws/Errors").EndpointError | import("@distilled.cloud/aws/Credentials").ExpiredSSOToken | import("@distilled.cloud/aws/Errors").ExpiredTokenException | import("effect/unstable/http/HttpClientError").HttpClientError | import("@distilled.cloud/aws/Errors").IncompleteSignature | import("@distilled.cloud/aws/Errors").InternalFailure | iam.InvalidInputException | logs.InvalidParameterException | ecr.InvalidParameterException | ecs.InvalidParameterException | import("@distilled.cloud/aws/Credentials").InvalidSSOProfile | import("@distilled.cloud/aws/Credentials").InvalidSSOToken | import("@distilled.cloud/aws/SigV4").InvalidSigningHeaders | import("@distilled.cloud/aws/SigV4").InvalidSigningUrl | ecr.KmsException | iam.LimitExceededException | import("@distilled.cloud/aws/Errors").MalformedHttpRequestException | import("@distilled.cloud/aws/Credentials").MissingRegion | import("@distilled.cloud/aws/Errors").NoMatchingRuleError | import("@distilled.cloud/aws/Errors").NotAuthorized | import("@distilled.cloud/aws/Errors").OperationAborted | logs.OperationAbortedException | import("@distilled.cloud/aws/Errors").OptInRequired | import("effect/PlatformError").PlatformError | import("@distilled.cloud/aws/Credentials").ProfileNotFound | ecr.RepositoryNotEmptyException | import("@distilled.cloud/aws/Errors").RequestAbortedException | import("@distilled.cloud/aws/Errors").RequestEntityTooLargeException | import("@distilled.cloud/aws/Errors").RequestExpired | import("@distilled.cloud/aws/Errors").RequestTimeoutException | ecr.ServerException | ecs.ServerException | iam.ServiceFailureException | import("@distilled.cloud/aws/Errors").ServiceUnavailable | logs.ServiceUnavailableException | import("@distilled.cloud/aws/Credentials").SsoPortalError | import("@distilled.cloud/aws/Errors").ThrottlingException | import("@distilled.cloud/aws/Errors").UnknownAwsError | import("@distilled.cloud/aws/Errors").UnknownOperationException | iam.UnmodifiableEntityException | import("@distilled.cloud/aws/Errors").UnrecognizedClientException | import("@distilled.cloud/aws/Errors").ValidationError | import("@distilled.cloud/aws/Errors").ValidationException | logs.ValidationException, Credentials | import("effect/unstable/http/HttpClient").HttpClient>;
export declare const TaskProvider: () => import("effect/Layer").Layer<Provider.Provider<Task>, never, AWSEnvironment | import("../../AlchemyContext.ts").AlchemyContext | Credentials | import("../../Docker/Docker.ts").Docker | import("effect/FileSystem").FileSystem | import("effect/unstable/http/HttpClient").HttpClient | import("effect/Path").Path | Stack | import("../../Stage.ts").Stage>;
