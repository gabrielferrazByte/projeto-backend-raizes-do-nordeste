...
export declare const resolveInstance: (instanceArn?: string | undefined) => Effect.Effect<ssoAdmin.InstanceMetadata, Error | import("effect/unstable/http/HttpClientError").HttpClientError | import("effect/PlatformError").PlatformError, import("@distilled.cloud/aws/Credentials").Credentials | import("effect/unstable/http/HttpClient").HttpClient>;
export declare const resolveIdentityStoreId: (args_0: {
    identityStoreId?: string;
    instanceArn?: string;
}) => Effect.Effect<string, Error | import("effect/unstable/http/HttpClientError").HttpClientError | import("effect/PlatformError").PlatformError, import("@distilled.cloud/aws/Credentials").Credentials | import("effect/unstable/http/HttpClient").HttpClient>;
