 ...
 */
export declare const imageSourceKind: (source: ImageSourceLike) => ImageSourceKind | undefined;
/**
 ...
 */
export declare const validateImageSource: (id: string, source: ImageSourceLike) => Effect.Effect<void>;
 ...
 */
export declare const makeBunBootstrap: (handler: string) => (importPath: string) => string;
/**
 ...
 */
export declare const computeStaticSourceHash: (source: ImageSourceLike, platform?: string | undefined) => Effect.Effect<string | undefined, import("effect/PlatformError").PlatformError, FileSystem.FileSystem | Path.Path>;
/**
 ...
 */
export declare const makeImageSource: Effect.Effect<{
    resolve: (options: ResolveImageOptions) => Effect.Effect<{
        imageUri: string;
        repositoryName: string;
        repositoryUri: string;
        codeHash: string;
    }, import("@distilled.cloud/aws/Errors").AccessDeniedException | import("@distilled.cloud/aws/Credentials").AwsCredentialProviderError | Bundle.BundleError | import("@distilled.cloud/aws/Credentials").ConflictingSSORegion | import("@distilled.cloud/aws/Credentials").ConflictingSSOStartUrl | import("@distilled.cloud/aws/SigV4").CryptoError | import("../../Docker/RegistryError.ts").DockerRegistryBlobUnknown | import("../../Docker/RegistryError.ts").DockerRegistryUnavailable | import("@distilled.cloud/aws/Errors").EndpointError | import("@distilled.cloud/aws/Credentials").ExpiredSSOToken | import("@distilled.cloud/aws/Errors").ExpiredTokenException | import("effect/unstable/http/HttpClientError").HttpClientError | import("@distilled.cloud/aws/Errors").IncompleteSignature | import("@distilled.cloud/aws/Errors").InternalFailure | ecr.InvalidParameterException | import("@distilled.cloud/aws/Credentials").InvalidSSOProfile | import("@distilled.cloud/aws/Credentials").InvalidSSOToken | import("@distilled.cloud/aws/SigV4").InvalidSigningHeaders | import("@distilled.cloud/aws/SigV4").InvalidSigningUrl | ecr.InvalidTagParameterException | ecr.KmsException | ecr.LimitExceededException | import("@distilled.cloud/aws/Errors").MalformedHttpRequestException | import("@distilled.cloud/aws/Credentials").MissingRegion | import("@distilled.cloud/aws/Errors").NoMatchingRuleError | import("@distilled.cloud/aws/Errors").NotAuthorized | import("@distilled.cloud/aws/Errors").OperationAborted | import("@distilled.cloud/aws/Errors").OptInRequired | import("effect/PlatformError").PlatformError | import("@distilled.cloud/aws/Credentials").ProfileNotFound | ecr.RepositoryNotFoundException | import("@distilled.cloud/aws/Errors").RequestAbortedException | import("@distilled.cloud/aws/Errors").RequestEntityTooLargeException | import("@distilled.cloud/aws/Errors").RequestExpired | import("@distilled.cloud/aws/Errors").RequestTimeoutException | ecr.ServerException | import("@distilled.cloud/aws/Errors").ServiceUnavailable | import("@distilled.cloud/aws/Credentials").SsoPortalError | import("@distilled.cloud/aws/Errors").ThrottlingException | import("effect/Cause").TimeoutError | ecr.TooManyTagsException | import("@distilled.cloud/aws/Errors").UnknownAwsError | import("@distilled.cloud/aws/Errors").UnknownOperationException | import("@distilled.cloud/aws/Errors").UnrecognizedClientException | import("@distilled.cloud/aws/Errors").ValidationError | import("@distilled.cloud/aws/Errors").ValidationException, import("@distilled.cloud/aws/Credentials").Credentials | FileSystem.FileSystem | import("effect/unstable/http/HttpClient").HttpClient | Path.Path | import("../../Stack.ts").Stack | import("../../Stage.ts").Stage>;
    hash: (options: {
        source: ImageSourceLike;
        platform?: string;
        port?: number;
        isExternal?: boolean;
        bootstrap: (importPath: string) => string;
    }) => Effect.Effect<string | undefined, Bundle.BundleError | import("effect/PlatformError").PlatformError, FileSystem.FileSystem | Path.Path>;
    watchMain: (options: {
        ...
        extra: Bundle.BundleConfig | undefined;
    }, import("effect/PlatformError").PlatformError, FileSystem.FileSystem | Path.Path>;
}, never, AlchemyContext | Docker | Path.Path>;
