...
import { captureAwsEnvironment, pinCollectionEnvironment, } from "./Local/ProviderContext.js";
import { flociDual, flociServices } from "./Local/FlociServices.js";
...
export const providers = () => Layer.effect(Providers, 
...
// cloud regardless.
Effect.flatMap(Provider.collection([
    KeyPair,
    Random,
...
ProviderLayer.dual(ECS.Service, {
    ...
    dataPlane: flociServices,
}), EFS.AccessPointProvider(), EFS.FileSystemProvider(), EFS.MountTargetProvider(), EKS.AccessEntryProvider(), EKS.AddonProvider(), EKS.ClusterProvider(), EKS.FargateProfileProvider(), EKS.NodegroupProvider(), EKS.PodIdentityAssociationProvider(), flociDual(ElastiCache.CacheCluster, () => ElastiCache.CacheClusterProvider()), flociDual(ElastiCache.ReplicationGroup, () => ElastiCache.ReplicationGroupProvider()), ElastiCache.ServerlessCacheProvider(), flociDual(ElastiCache.SubnetGroup, () => ElastiCache.SubnetGroupProvider()), 
...
ProviderLayer.dual(Lambda.Function, {
    ...
    dataPlane: flociServices,
}), flociDual(Lambda.LayerVersion, () => Lambda.LayerVersionProvider()), flociDual(Lambda.Version, () => Lambda.VersionProvider()), 
...
(base) => Layer.unwrap(Effect.gen(function* () {
