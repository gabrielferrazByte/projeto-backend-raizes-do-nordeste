...
import { findPublicHostedZoneId } from "../Route53/HostedZoneLookup.js";
/**
...
export const CertificateProvider = () => Provider.effect(Certificate, Effect.gen(function* () {
    ...
    return {
        ...
        reconcile: Effect.fn(function* ({ id, instanceId, news: _news, output, session, bindings, }) {
            ...
            if ((news.validationMethod ?? defaultValidationMethod) === "DNS" &&
                certificate.Status !== "ISSUED") {
                const validationZoneId = news.hostedZoneId ??
