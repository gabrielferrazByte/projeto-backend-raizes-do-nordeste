...
export declare const WAKU_AWS_TARGET_SPECIFIER = "@alchemy.run/frontend-frameworks/waku/aws";
 ...
 * @resource
 */
export declare const Waku: (id: string, props?: InputProps<WakuProps>) => import("effect/Effect").Effect<{
    bucket: undefined;
