...
export declare const REACT_ROUTER_AWS_TARGET_SPECIFIER = "@alchemy.run/frontend-frameworks/react-router/aws";
 ...
 * @resource
 */
export declare const ReactRouter: (id: string, props?: InputProps<ReactRouterProps>) => import("effect/Effect").Effect<{
    bucket: undefined;
