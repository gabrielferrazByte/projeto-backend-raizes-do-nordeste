...
export declare const SOLIDSTART_FRAMEWORK_SPECIFIER = "@alchemy.run/frontend-frameworks/solidstart";
/** The AWS Lambda deploy target for the SolidStart build. */
export declare const SOLIDSTART_AWS_TARGET_SPECIFIER = "@alchemy.run/frontend-frameworks/solidstart/aws";
 ...
 * @resource
 */
export declare const SolidStart: (id: string, props?: InputProps<SolidStartProps>) => import("effect/Effect").Effect<{
    bucket: undefined;
