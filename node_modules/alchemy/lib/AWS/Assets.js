    ...
    const bucketName = yield* lookupAssetsBucket.pipe(Effect.flatMap(Option.match({
        onNone: () => Effect.gen(function* () {
            ...
            if (!environment.endpoint) {
                return yield* Effect.die(new Error("Assets bucket not found. Run 'alchemy provider aws bootstrap' to create it."));
            }
