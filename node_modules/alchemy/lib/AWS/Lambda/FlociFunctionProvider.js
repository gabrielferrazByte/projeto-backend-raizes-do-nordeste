...
export const FlociFunctionProvider = () => makeDevWatchProvider(Function, flociProvidersUrl(), {
    ...
    // hashing.
    watchConfigOf: (news, attrs) => isFunctionImageProps(news)
        ? {
    ...
    normalizeProps: (props) => isFunctionImageProps(props)
        ? props
        : {
            ...props,
    ...
    transformPrecreateNews: (news) => isFunctionImageProps(news)
        ? news
        : {
            ...news,
            bundle: undefined,
