 ...
 * @binding
 */
export interface Connect extends Binding.Service<Connect, "AWS.RDS.Connect", (resource: ConnectResource, options: ConnectOptions) => Effect.Effect<Effect.Effect<ConnectionInfo, secretsmanager.GetSecretValueError | Presign.PresignError, RuntimeContext>>> {
}
