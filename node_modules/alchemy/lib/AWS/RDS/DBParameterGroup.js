...
export const DBParameterGroupProvider = () => Provider.effect(DBParameterGroup, Effect.gen(function* () {
    ...
    const readTags = Effect.fn(function* (arn) {
        ...
        return Object.fromEntries((response.TagList ?? []).flatMap(({ Key, Value }) => Key !== undefined && Value !== undefined ? [[Key, Value]] : []));
    });
    ...
    const toManagedParameterRecord = (parameters, desired = {}) => Object.fromEntries(parameters.flatMap((p) => p.ParameterName !== undefined &&
    ...
    return {
        ...
        diff: Effect.fn(function* ({ id, olds, news, output }) {
            ...
            if (output !== undefined) {
                ...
                const parameters = yield* readParameters(output.dbParameterGroupName).pipe(Effect.catchTag("DBParameterGroupNotFoundFault", () => Effect.succeed(undefined)));
        ...
        read: Effect.fn(function* ({ id, olds, output }) {
            ...
            const parameters = toManagedParameterRecord(yield* readParameters(group.DBParameterGroupName), olds?.parameters);
            return {
        ...
        reconcile: Effect.fn(function* ({ id, news, output, session }) {
            ...
            const parameters = yield* readParameters(name).pipe(Effect.flatMap((parameters) => {
