 ...
 */
export declare const generateDbAuthToken: (options: GenerateDbAuthTokenOptions) => Effect.Effect<Redacted.Redacted<string>, Presign.PresignError, Credentials.Credentials | Region.Region>;
