...
export declare const SecurityGroupProvider: () => import("effect/Layer").Layer<Provider.Provider<SecurityGroup>, never, AWSEnvironment | import("@distilled.cloud/aws/Credentials").Credentials | import("effect/unstable/http/HttpClient").HttpClient | Stack | import("../../Stage.ts").Stage | State>;
