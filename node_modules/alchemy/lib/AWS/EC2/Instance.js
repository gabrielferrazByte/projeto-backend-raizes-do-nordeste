...
export const InstanceProvider = () => Provider.effect(Instance, Effect.gen(function* () {
    ...
    return {
        ...
        diff: Effect.fn(function* ({ id, news, olds, output }) {
            ...
            if (isResolved(contentInputs) &&
                contentInputs.main !== undefined &&
                output?.code?.hash) {
                const { hash } = yield* hosted.bundleProgram(id, contentInputs);
            ...
            if (!isResolved(news))
                return;
            const reusesFixedPrivateIp = news.privateIpAddress !== undefined &&
