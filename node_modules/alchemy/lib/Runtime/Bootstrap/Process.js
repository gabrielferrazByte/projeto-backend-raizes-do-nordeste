...
import { makeEntrypointLayer } from "../../Runtime.js";
import { Self } from "../../Self.js";
import { Stack } from "../../Stack.js";
import { provideProcessTelemetry } from "../../Telemetry.js";
/**
 ...
 */
export const entrypointTag = Context.Service(Self.key);
/**
 ...
 */
export const entrypointLayer = (entrypoint) => makeEntrypointLayer(entrypointTag, entrypoint);
/** `Stack` from the `ALCHEMY_STACK_NAME` / `ALCHEMY_STAGE` the host injects. */
export const stackFromEnv = Layer.effect(Stack, Effect.all([
    Config.String("ALCHEMY_STACK_NAME"),
    Config.String("ALCHEMY_STAGE"),
]).pipe(Effect.map(([name, stage]) => ({
    name,
    stage,
    bindings: {},
    resources: {},
...
export const stackConstant = (name, stage) => Layer.succeed(Stack, {
    name,
    stage,
    bindings: {},
    resources: {},
 ...
 */
export const resolveProgram = (exportKey, options) => entrypointTag.pipe(Effect.flatMap((self) => {
    const program = self.RuntimeContext.exports.pipe(Effect.flatMap((exports) => exports[exportKey]));
 ...
 */
export const runProcess = (label, program, options) => {
