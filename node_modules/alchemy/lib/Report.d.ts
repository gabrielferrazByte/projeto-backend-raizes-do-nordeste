...
export type ApplyStatus = "attaching" | "post-attach" | "pending" | "pre-creating" | "creating" | "creating replacement" | "created" | "updating" | "updated" | "adopting" | "adopted" | "deleting" | "deleted" | "orphaning" | "orphaned" | "replacing" | "replaced" | "running" | "ran" | "skipped" | "fail";
...
export type PlanningPhase = "importing-module" | "resolving-services" | "loading-state" | "computing-plan" | "plan-ready";
/**
...
export type NukeEvent = NukeScanStarted | NukeProviderScanStarted | NukePassStarted | NukeProviderScanned | NukeResourceDeleted | NukeResourceFailed;
...
export type ProviderEvent = ProviderConfigureStarted | ProviderConfigureCompleted | ProviderRefreshStarted | ProviderRefreshCompleted;
/**
 ...
 */
export declare const Progress: Context.Reference<ProgressReporter>;
...
export declare const noopSession: PlanStatusSession;
export interface PlanningStatusSession {
    update: (label: string, detail?: string, options?: {
        /**
...
export interface CLIService {
    startPlanningSession: (label: string, detail?: string, title?: string) => Effect.Effect<PlanningStatusSession>;
    approvePlan: <P extends Plan>(plan: P, options?: PlanDisplayOptions) => Effect.Effect<boolean, NonInteractiveTerminal>;
    displayPlan: <P extends Plan>(plan: P, options?: PlanDisplayOptions) => Effect.Effect<void>;
    startApplySession: <P extends Plan>(plan: P, options?: PlanDisplayOptions) => Effect.Effect<PlanStatusSession>;
}
