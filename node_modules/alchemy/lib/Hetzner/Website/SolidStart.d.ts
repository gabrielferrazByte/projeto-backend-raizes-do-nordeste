...
export declare const SOLIDSTART_NODE_TARGET_SPECIFIER = "@alchemy.run/frontend-frameworks/solidstart/node";
 ...
 * @product Website
 */
export declare const SolidStart: (id: string, props?: SolidStartProps) => import("effect/Effect").Effect<{
