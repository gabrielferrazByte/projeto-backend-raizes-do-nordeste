...
export type TaxRegistrationUnitedStatesType = "local_amusement_tax" | "local_lease_tax" | "state_communications_tax" | "state_retail_delivery_fee" | "state_sales_tax";
/** Election type for a US state sales tax registration. */
export type TaxRegistrationUsStateSalesTaxElectionType = "local_use_tax" | "simplified_sellers_use_tax" | "single_local_use_tax";
/** ISO country codes that use a standard (optionally inbound-goods) registration. */
export type TaxRegistrationStandardCountryCode = "ae" | "al" | "ao" | "au" | "aw" | "ba" | "bb" | "bd" | "bf" | "bh" | "bs" | "cd" | "ch" | "et" | "gb" | "gn" | "is" | "jp" | "me" | "mk" | "mr" | "no" | "nz" | "om" | "rs" | "sg" | "sr" | "uy" | "za" | "zw";
/** ISO country codes that use a simplified registration. */
export type TaxRegistrationSimplifiedCountryCode = "am" | "az" | "bj" | "by" | "cl" | "cm" | "co" | "cr" | "cv" | "ec" | "eg" | "ge" | "id" | "in" | "ke" | "kg" | "kh" | "kr" | "kz" | "la" | "lk" | "ma" | "md" | "mx" | "my" | "ng" | "np" | "pe" | "ph" | "ru" | "sa" | "sn" | "th" | "tj" | "tr" | "tw" | "tz" | "ua" | "ug" | "uz" | "vn" | "zm";
/** ISO country codes that use an EU registration (standard / OSS / IOSS). */
export type TaxRegistrationEuropeCountryCode = "at" | "be" | "bg" | "cy" | "cz" | "de" | "dk" | "ee" | "es" | "fi" | "fr" | "gr" | "hr" | "hu" | "ie" | "it" | "lt" | "lu" | "lv" | "mt" | "nl" | "pl" | "pt" | "ro" | "se" | "si" | "sk";
...
export type TaxRegistration = Resource<"Stripe.TaxRegistration", TaxRegistrationProps, {
 ...
 * @resource
 */
export declare const TaxRegistration: import("../Resource.ts").ResourceClass<TaxRegistration>;
declare const TaxRegistrationNotResolved_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "Stripe.TaxRegistrationNotResolved";
} & Readonly<A>;
export declare class TaxRegistrationNotResolved extends TaxRegistrationNotResolved_base<{
    country: string;
}> {
}
export declare const TaxRegistrationProvider: () => import("effect/Layer").Layer<Provider.Provider<TaxRegistration>, never, import("@distilled.cloud/stripe").StripeOpContext>;
export {};
//# sourceMappingURL=TaxRegistration.d.ts.map