...
import { CreateCreditGrant } from "./CreateCreditGrant.js";
 ...
 */
export const CreateCreditGrantHttp = Layer.effect(CreateCreditGrant, makeHttpStripeAccountBinding({
    tag: "Stripe.CreateCreditGrant",
    operation: CreateBillingCreditGrant,
    permissions: ["credit_grants_write"],
}));
//# sourceMappingURL=CreateCreditGrantHttp.js.map