...
import { UpdateIssuingCard } from "./UpdateIssuingCard.js";
/**
 ...
 */
export const UpdateIssuingCardHttp = Layer.effect(UpdateIssuingCard, makeHttpStripeIdBinding({
    tag: "Stripe.UpdateIssuingCard",
    operation: updateIssuingCardOp,
    idField: "card",
    permissions: ["issuing_write"],
}));
//# sourceMappingURL=UpdateIssuingCardHttp.js.map