...
import { UpdateIssuingCardholder } from "./UpdateIssuingCardholder.js";
/**
 ...
 */
export const UpdateIssuingCardholderHttp = Layer.effect(UpdateIssuingCardholder, makeHttpStripeIdBinding({
    tag: "Stripe.UpdateIssuingCardholder",
    operation: updateIssuingCardholderOp,
    idField: "cardholder",
    permissions: ["issuing_write"],
}));
//# sourceMappingURL=UpdateIssuingCardholderHttp.js.map