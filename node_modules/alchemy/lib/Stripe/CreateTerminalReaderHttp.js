...
import { CreateTerminalReader } from "./CreateTerminalReader.js";
import { makeHttpStripeAccountBinding } from "./StripeHttp.js";
/**
 ...
 */
export const CreateTerminalReaderHttp = Layer.effect(CreateTerminalReader, makeHttpStripeAccountBinding({
    tag: "Stripe.CreateTerminalReader",
    operation: createTerminalReaderOp,
    permissions: ["terminal_write"],
}));
//# sourceMappingURL=CreateTerminalReaderHttp.js.map