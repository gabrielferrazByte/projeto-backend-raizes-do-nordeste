...
import { RetrievePaymentLink } from "./RetrievePaymentLink.js";
 ...
 */
export const RetrievePaymentLinkHttp = Layer.effect(RetrievePaymentLink, makeHttpStripeIdBinding({
    tag: "Stripe.RetrievePaymentLink",
    operation: GetPaymentLink,
    idField: "payment_link",
    permissions: ["payment_links_read"],
}));
//# sourceMappingURL=RetrievePaymentLinkHttp.js.map