...
import { RetrieveTerminalConfiguration } from "./RetrieveTerminalConfiguration.js";
 ...
 */
export const RetrieveTerminalConfigurationHttp = Layer.effect(RetrieveTerminalConfiguration, makeHttpStripeIdBinding({
    tag: "Stripe.RetrieveTerminalConfiguration",
    operation: GetTerminalConfiguration,
    idField: "configuration",
    permissions: ["terminal_read"],
}));
//# sourceMappingURL=RetrieveTerminalConfigurationHttp.js.map