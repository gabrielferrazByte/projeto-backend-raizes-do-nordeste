 ...
 */
export const CreateCheckoutSessionHttp = Layer.effect(CreateCheckoutSession, makeHttpStripeAccountBinding({
    tag: "Stripe.CreateCheckoutSession",
    operation: createCheckoutSessionOp,
    permissions: ["checkout_sessions_write"],
}));
//# sourceMappingURL=CreateCheckoutSessionHttp.js.map