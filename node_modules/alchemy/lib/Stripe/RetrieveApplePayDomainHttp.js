...
import { RetrieveApplePayDomain } from "./RetrieveApplePayDomain.js";
 ...
 */
export const RetrieveApplePayDomainHttp = Layer.effect(RetrieveApplePayDomain, makeHttpStripeIdBinding({
    tag: "Stripe.RetrieveApplePayDomain",
    operation: GetApplePayDomain,
    idField: "domain",
    permissions: ["apple_pay_domains_read"],
}));
//# sourceMappingURL=RetrieveApplePayDomainHttp.js.map