...
export interface TeamAccess extends Resource<"GitHub.TeamAccess", TeamAccessProps, {
    /**
     * Team slug.
     */
    teamSlug: string;
 ...
 * @resource
 */
export declare const TeamAccess: import("../Resource.ts").ResourceClass<TeamAccess>;
export declare const TeamAccessProvider: () => import("effect/Layer").Layer<Provider.Provider<TeamAccess>, never, GitHub.GitHubCredentials>;
//# sourceMappingURL=TeamAccess.d.ts.map