...
import { resolveConnectionOptions } from "../SQL/PostgresTls.js";
...
export const makePostgresState = (options, scope) => Effect.gen(function* () {
    ...
    const openPool = (url) => Effect.gen(function* () {
        ...
        const resolved = Effect.isEffect(url)
            ...
            : url;
        const built = yield* Layer.build(PgClient.layer(resolveConnectionOptions(resolved))).pipe(Scope.provide(scope), stateError);
