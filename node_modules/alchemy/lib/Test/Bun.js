...
const DEFAULT_HOOK_TIMEOUT = { timeout: 120_000 };
/**
...
export const make = (options) => {
    ...
    const runProvider = (name, fn) => {
        ...
        return Core.run(Core.withProviders(fn(scratch), options, scratch.name), { ...options, state: scratch.state }, sharedScope, sidecar);
    };
    ...
    // returns.)
    const guardTeardown = (eff) => () => runEff(eff).catch(async (error) => {
