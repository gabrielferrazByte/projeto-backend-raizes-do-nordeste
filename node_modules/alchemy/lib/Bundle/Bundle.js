 ...
 */
export const BUN_CONDITION_NAMES = [
    "bun",
    "module",
    "default",
];
export const NODE_CONDITION_NAMES = [
    "node",
    "module",
    "default",
];
            ...
            resolveId: {
                ...
                async handler(id, importer) {
                    ...
                    if (resolved === null) {
                        ...
                        this.error(new Error(`The generated entry for ${entry} imports "${id}", which cannot be resolved from the project. ` +
