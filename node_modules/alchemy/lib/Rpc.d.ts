 ...
 */
export declare const makeRpcErrorReviver: (errors: ReadonlyArray<RpcErrorClass> | undefined) => ((error: unknown) => unknown);
/**
 ...
 */
export declare const decodeRpcResult: (value: unknown, revive?: (error: unknown) => unknown) => Effect.Effect<unknown, unknown>;
