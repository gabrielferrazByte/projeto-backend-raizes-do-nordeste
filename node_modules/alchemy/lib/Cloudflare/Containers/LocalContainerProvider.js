...
import { generateLocalId, LOCAL_PROVIDERS_URL } from "../LocalRuntime.js";
 ...
 */
export const LocalContainerProvider = () => RpcProvider.effect(ContainerPlatform, LOCAL_PROVIDERS_URL, Effect.gen(function* () {
     ...
     */
    const resolvedImageInputs = (input) => {
