...
const toHttpUrl = (url) => url.startsWith("https:") ? `http:${url.slice("https:".length)}` : url;
/**
 ...
 */
const httpSchemePort = (port) => ({
    fetch: (input, init) => input instanceof Request
    ...
    bind: Effect.fn(function* (containerEff) {
        ...
        return Effect.gen(function* () {
            ...
            return {
                ...
                getTcpPort: (port) => Effect.sync(() => fromCloudflareFetcher(httpSchemePort(state.container.getTcpPort(port)))),
