...
import {} from "../Workers/Worker.js";
import { ContainerPlatform } from "./ContainerPlatform.js";
export const ContainerTypeId = "Cloudflare.Container";
export const ContainerTag = (id) => Context.Service(`Container<${id}>`);
export const isContainer = (value) => typeof value === "object" &&
    value !== null &&
    "Type" in value &&
 ...
 */
export const Container = Object.assign((...args) => {
    if (args.length === 0) {
        return (...args) => {
            if (args.length === 1) {
                const [id] = args;
                ...
                return Object.assign(effectClass(ContainerTag(id)), {
                    ...
                    make: (props, impl) => tag.make(props, impl),
        ...
        return Object.assign(effectClass(ContainerTag(id)), {
            ...
            "~alchemy/Container/ClassName": Effect.isEffect(props)
                ? Effect.map(props, (resolved) => resolved?.className)
                : props?.className,
            // yield* MyContainer.Application to get the ContainerApplication Resource Outputs
