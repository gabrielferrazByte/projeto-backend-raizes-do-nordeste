...
export declare const ContainerProvider: () => import("effect/Layer").Layer<import("../../Provider.ts").Provider<ContainerApplication<unknown>>, never, import("../../AlchemyContext.ts").AlchemyContext | import("../../Artifacts.ts").ArtifactStore | import("../CloudflareEnvironmentService.ts").CloudflareEnvironment | import("../../Docker/Docker.ts").Docker | import("effect/FileSystem").FileSystem | import("effect/Path").Path | import("../../Stack.ts").Stack | import("../../Stage.ts").Stage | Containers.CloudflareOpContext>;
