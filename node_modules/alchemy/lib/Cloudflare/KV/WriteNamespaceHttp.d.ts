 ...
 */
export declare const WriteNamespaceHttp: Layer.Layer<WriteNamespace, never, import("../CloudflareEnvironmentService.ts").CloudflareEnvironment | import("../../Self.ts").Self<{
    Type: string;
    LogicalId: string;
}>>;
