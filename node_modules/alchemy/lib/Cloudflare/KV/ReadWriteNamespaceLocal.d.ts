 ...
 */
export declare const ReadWriteNamespaceLocal: Layer.Layer<ReadWriteNamespace, never, import("../CloudflareEnvironmentService.ts").CloudflareEnvironment | import("@distilled.cloud/cloudflare/Credentials").Credentials | import("effect/unstable/http/HttpClient").HttpClient>;
