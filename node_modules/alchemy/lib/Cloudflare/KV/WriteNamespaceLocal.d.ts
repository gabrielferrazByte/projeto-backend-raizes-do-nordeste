 ...
 * ```
 */
export declare const WriteNamespaceLocal: Layer.Layer<WriteNamespace, never, import("../CloudflareEnvironmentService.ts").CloudflareEnvironment | import("@distilled.cloud/cloudflare/Credentials").Credentials | import("effect/unstable/http/HttpClient").HttpClient>;
