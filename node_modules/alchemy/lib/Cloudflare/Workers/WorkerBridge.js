...
const getSharedBuild = (entrypoint, stack) => {
    ...
    const globalContext = Layer.unwrap(cloudflare_workers.pipe(Effect.map(({ env }) => layer.pipe(Layer.provideMerge(Layer.succeed(StackContext, {
        name: stack.name,
        stage: stack.stage,
        bindings: {},
        resources: {},
