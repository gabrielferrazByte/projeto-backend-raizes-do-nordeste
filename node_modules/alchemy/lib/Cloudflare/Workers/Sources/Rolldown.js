...
import { workerModulePlugin } from "./WorkerModulePlugin.js";
/**
...
export const WorkerBundle = Effect.gen(function* () {
    ...
    const makeOptions = Effect.fn(function* (options) {
        ...
        const cwd = yield* findCwdForBundle(realMain).pipe(Effect.mapError((cause) => new Bundle.BundleError({
        ...
        const cloudflarePlugins = () => rebindEsmExternalRequirePlugin(cloudflareRolldown({
            compatibilityDate: options.compatibility.date,
            compatibilityFlags: options.compatibility.flags,
        }), esmExternalRequirePlugin);
        const workerModules = workerModulePlugin({
