...
import { ExportedHandlerMethods, WorkerEnvironment, WorkerExecutionContext, WorkerTypeId, deferredExecutionContext, } from "./WorkerRuntime.js";
    ...
    const ctx = {
        ...
        exports: Effect.gen(function* () {
            ...
            const dispatch = (type) => (request, env, context) => {
                ...
                if (effects.length > 1) {
                    return [
                        Effect.all(effects, { concurrency: "unbounded" }).pipe(Effect.map((results) => {
