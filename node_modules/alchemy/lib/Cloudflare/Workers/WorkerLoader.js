...
export const WorkerLoader = Object.assign(taggedFunction(Context.Service()("Cloudflare.WorkerLoader"), (name = "LOADER") => Object.assign(Effect.gen(function* () {
    ...
    return {
        ...
        get: (name, getCode) => Effect.flatMap(Effect.context(), (context) => Effect.sync(() => 
        ...
        wrapWorkerStub(loader.get(name, () => asEffect(getCode()).pipe(Effect.provide(context), Effect.map(unwrapWorkerLoader), Effect.runPromise))))),
    };
}), {
    "~alchemy/Name": name,
