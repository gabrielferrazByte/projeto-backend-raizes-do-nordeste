...
export const DurableObject = taggedFunction(DurableObjectScope, function (...args) {
    ...
    const binding = (scriptName, transferredFrom, errors) => Effect.gen(function* () {
        ...
        return {
            ...
            getByName: (name, options) => makeRpcStub(binding.getByName(name, options), { errors }),
        ...
        return class extends effectClass(tag) {
            ...
            static from = (worker) => {
                ...
                const resolved = typeof worker === "string"
                    ...
                    : asEffect(worker);
                return resolved.pipe(Effect.flatMap((w) => binding(typeof w === "string" ? w : w.workerName, undefined, classProps?.errors)));
            };
        };
    }
});
