 ...
 */
export interface WorkerEntrypointBinding<Entrypoint extends Rpc.WorkerEntrypointBranded | undefined = undefined> {
 ...
 */
export declare const WorkerEntrypoint: <Entrypoint extends Rpc.WorkerEntrypointBranded | undefined = undefined>(worker: Worker, entrypointOrOptions?: string | WorkerEntrypointOptions) => WorkerEntrypointBinding<NoInfer<Entrypoint>>;
/** Structural guard for {@link WorkerEntrypointBinding} `env` values. */
export declare const isWorkerEntrypoint: (value: unknown) => value is WorkerEntrypointBinding<any>;
export {};
