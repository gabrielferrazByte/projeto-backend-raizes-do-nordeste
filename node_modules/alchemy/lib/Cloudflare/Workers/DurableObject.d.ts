...
export type DurableObjectServices = DurableObject | DurableObjectState | DurableObjectScope | WorkerServices | WorkerEnvironment | PlatformServices;
/**
...
export interface DurableObjectClass extends Effect.Effect<DurableObject, never, DurableObject> {
    <Self, Shape>(): {
        <Name extends string>(name: Name, props?: Pick<DurableObjectProps, "transferredFrom" | "errors">): Effect.Effect<DurableObject<Self>, never, Worker | Self> & {
            new (_: never): Shape & {
                /** @internal */
                "~alchemy/name": Name;
            };
            ...
            make<Req = never>(impl: Effect.Effect<Effect.Effect<Shape, never, RuntimeContext | DurableObjectState | Scope>, never, Req>): Layer.Layer<Self, never, Worker | Exclude<Req, DurableObjectServices>>;
        };
    };
    <Self>(): {
