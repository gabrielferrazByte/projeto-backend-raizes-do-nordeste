...
declare const WorkerPreviewConfigError_base: new <A extends Record<string, any> = {}>(args: import("effect/Types").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("effect/Cause").YieldableError & {
    readonly _tag: "WorkerPreviewConfigError";
} & Readonly<A>;
/**
 ...
 */
export declare class WorkerPreviewConfigError extends WorkerPreviewConfigError_base<{
    message: string;
}> {
}
/**
 ...
 * @internal
 */
export declare const resolvePreviewParentName: (preview: WorkerProps["preview"]) => string | undefined;
/**
