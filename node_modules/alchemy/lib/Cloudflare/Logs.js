...
export const CloudflareLogs = Effect.gen(function* () {
     ...
     */
    const explainMissingObservabilityScope = (effect) => effect.pipe(Effect.catchTag("Unauthorized", () => Effect.gen(function* () {
        const command = yield* profileCommandHint("alchemy profile edit --reconfigure Cloudflare");
        return yield* Effect.die(new Error("Cloudflare rejected the observability telemetry query (Unauthorized). " +
