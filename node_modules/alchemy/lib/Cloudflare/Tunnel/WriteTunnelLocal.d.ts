 ...
 * ```
 */
export declare const WriteTunnelLocal: Layer.Layer<WriteTunnel, never, import("../CloudflareEnvironmentService.ts").CloudflareEnvironment | import("@distilled.cloud/cloudflare/Credentials").Credentials | import("effect/unstable/http/HttpClient").HttpClient>;
