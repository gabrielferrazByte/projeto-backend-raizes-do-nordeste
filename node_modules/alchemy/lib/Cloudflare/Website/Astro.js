...
import { Namespace } from "../KV/Namespace.js";
 ...
 */
export const Astro = ((id, propsEff) => id === undefined
    ? (id, propsEff) => effectClass(Astro(id, propsEff))
    : Worker(id, Effect.gen(function* () {
