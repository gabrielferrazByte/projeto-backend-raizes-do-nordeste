 ...
 * ```
 */
export declare const ReadWriteBucketLocal: Layer.Layer<ReadWriteBucket, never, import("../CloudflareEnvironmentService.ts").CloudflareEnvironment | import("@distilled.cloud/cloudflare/Credentials").Credentials | import("effect/unstable/http/HttpClient").HttpClient>;
