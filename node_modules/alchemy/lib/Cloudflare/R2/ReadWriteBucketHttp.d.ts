 ...
 */
export declare const ReadWriteBucketHttp: Layer.Layer<ReadWriteBucket, never, import("../CloudflareEnvironmentService.ts").CloudflareEnvironment | import("../../Self.ts").Self<{
    Type: string;
    LogicalId: string;
}>>;
