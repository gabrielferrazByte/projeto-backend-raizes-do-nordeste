 ...
 * ```
 */
export declare const WriteBucketLocal: Layer.Layer<WriteBucket, never, import("../CloudflareEnvironmentService.ts").CloudflareEnvironment | import("@distilled.cloud/cloudflare/Credentials").Credentials | import("effect/unstable/http/HttpClient").HttpClient>;
