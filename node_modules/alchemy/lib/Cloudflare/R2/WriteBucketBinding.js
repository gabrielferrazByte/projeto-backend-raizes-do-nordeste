    ...
    return {
        ...
        put: (key, value, options) => use((raw) => {
            if (Stream.isStream(value)) {
                ...
                if (rawStream) {
                    return raw.put(key, rawStream, r2Options);
                }
                ...
                // length stream.
                const readable = Stream.toReadableStream(value).pipeThrough(new FixedLengthStream(contentLength));
                return raw.put(key, readable, r2Options);
            }
