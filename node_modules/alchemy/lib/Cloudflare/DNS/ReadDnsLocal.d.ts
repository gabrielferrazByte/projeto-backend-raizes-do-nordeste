 ...
 */
export declare const ReadDnsLocal: Layer.Layer<ReadDns, never, import("@distilled.cloud/cloudflare/Credentials").Credentials | import("effect/unstable/http/HttpClient").HttpClient>;
