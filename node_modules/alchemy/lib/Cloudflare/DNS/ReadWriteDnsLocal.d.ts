 ...
 */
export declare const ReadWriteDnsLocal: Layer.Layer<ReadWriteDns, never, import("@distilled.cloud/cloudflare/Credentials").Credentials | import("effect/unstable/http/HttpClient").HttpClient>;
