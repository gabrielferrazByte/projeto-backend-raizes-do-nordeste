 ...
 */
export declare const WriteDnsLocal: Layer.Layer<WriteDns, never, import("@distilled.cloud/cloudflare/Credentials").Credentials | import("effect/unstable/http/HttpClient").HttpClient>;
