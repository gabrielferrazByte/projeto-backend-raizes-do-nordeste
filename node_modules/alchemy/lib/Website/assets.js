...
export const staticConfigFromAssets = (assets, defaults) => {
    const handling = assets?.notFoundHandling ?? defaults?.notFoundHandling;
    if (handling === "single-page-application")
        return { spa: true };
    if (handling === "404-page")
 ...
 */
export const contentTypeOf = (relative) => {
 ...
 * a cached object.
 */
export const cacheControlOf = (relative) => {
