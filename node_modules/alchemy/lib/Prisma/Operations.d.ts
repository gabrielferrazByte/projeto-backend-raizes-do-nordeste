...
export declare const getDeploymentLogsRequest: (id: string, query?: DeploymentLogsQuery) => Effect.Effect<import("./Types.ts").DeploymentLogsRequest, import("@distilled.cloud/fly-io").ConfigError | import("./Client.ts").PrismaApiError, import("@distilled.cloud/prisma").Credentials>;
export declare const getBuildLogsRequest: (buildId: string, query?: BuildLogsQuery) => Effect.Effect<import("./Types.ts").BuildLogsRequest, import("@distilled.cloud/fly-io").ConfigError | import("./Client.ts").PrismaApiError, import("@distilled.cloud/prisma").Credentials>;
