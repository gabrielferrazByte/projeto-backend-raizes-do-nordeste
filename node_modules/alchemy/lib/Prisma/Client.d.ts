...
import { type ObservedConnection } from "./Internal/Observed.ts";
...
export declare const extractConnectionSecrets: (connection: ObservedConnection | undefined | null) => PrismaSecretConnection;
