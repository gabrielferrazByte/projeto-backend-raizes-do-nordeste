...
export interface ObservedDatabase {
    ...
    readonly connections: ReadonlyArray<ObservedConnection & {
        readonly id: string;
    }>;
    readonly region?: {
        readonly id: string;
...
export declare const requiredSecretValue: (value: string | Redacted.Redacted<string>) => string;
/** Read a possibly-redacted secret as a plain string. */
export declare const secretValue: (value: string | Redacted.Redacted<string> | undefined | null) => string | undefined;
/**
 ...
 */
export declare const narrowDatabaseSource: (source: ObservedSource | undefined | null) => {
    readonly type: "empty";
} | {
