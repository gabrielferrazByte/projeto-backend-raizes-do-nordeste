...
export const REACT_ROUTER_NODE_TARGET_SPECIFIER = "@alchemy.run/frontend-frameworks/react-router/node";
/**
 ...
 * @product Website
 */
export const ReactRouter = (id, props = {}) => frameworkSite(id, props, {
    name: "ReactRouter",
