...
export const TANSTACK_START_NODE_TARGET_SPECIFIER = "@alchemy.run/frontend-frameworks/tanstack-start/node";
/**
 ...
 * @product Website
 */
export const TanStackStart = (id, props = {}) => frameworkSite(id, props, {
    name: "TanStackStart",
