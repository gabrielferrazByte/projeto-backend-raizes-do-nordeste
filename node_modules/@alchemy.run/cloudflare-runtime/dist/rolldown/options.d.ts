//#region src/rolldown/options.d.ts
 ...
 */
declare const isSkippedEnvironment: (options: BasePluginOptions, name: string) => boolean;
declare const parseViteEnvironments: (options: BasePluginOptions) => [string, ...Array<string>];
//#endregion
export { BasePluginOptions, isSkippedEnvironment, parseViteEnvironments };
