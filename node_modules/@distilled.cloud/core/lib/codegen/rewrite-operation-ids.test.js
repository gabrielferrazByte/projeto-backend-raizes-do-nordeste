...
import { isMechanicalOperationId, isVerbatimRouteId, pathToVerbNoun, singularize, toVerbNoun, verbNounSmithyModel, } from "./rewrite-operation-ids.js";
const cases = [
...
describe("pathToVerbNoun", () => {
    test.each([
        ...
        expect(pathToVerbNoun({ method, path }, { returnsCollection: expected.startsWith("list") })).toBe(expected);
    });
});
...
//# sourceMappingURL=rewrite-operation-ids.test.js.map