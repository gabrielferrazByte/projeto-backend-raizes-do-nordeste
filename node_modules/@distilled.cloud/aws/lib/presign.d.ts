 ...
 */
export declare const presignUrl: (options: PresignUrlOptions) => Effect.Effect<string, PresignError, PresignContext>;
/**
 ...
 */
export declare const presignS3Url: (options: PresignS3UrlOptions) => Effect.Effect<string, PresignError, PresignContext>;
