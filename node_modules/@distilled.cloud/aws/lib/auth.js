 ...
 * session.
 */
export const ssoTokenCacheName = (ssoCacheKey) => sha1(ssoCacheKey);
/**
 ...
 */
export const ssoRoleCredentialsCacheName = (profile) => sha1([
...
export const makeAuthService = () => Effect.gen(function* () {
    ...
    const loadProfileCredentials = Effect.fn(function* (profileName) {
        ...
        if (ssoCacheKey) {
            ...
            // fetched first (#565).
            const cachedCredsFilePath = path.join(cachePath, `${ssoRoleCredentialsCacheName(profile)}.credentials.json`);
            ...
            const isCacheHit = (creds) => creds !== undefined &&
                creds !== null &&
