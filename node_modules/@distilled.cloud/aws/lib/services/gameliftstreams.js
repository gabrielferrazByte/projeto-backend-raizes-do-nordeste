...
export class StreamSessionAccessNotReadyException extends /*@__PURE__*/ /*@__PURE__*/ S.TaggedError()("StreamSessionAccessNotReadyException", { message: S.String.pipe(T.ErrorMessage()) }, T.all(T.HttpError(409), T.Retryable())).pipe(C.withConflictError, C.withRetryableError) {
}
...
export const CreateStreamSessionAdminShellInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Identifier: S.String.pipe(T.HttpLabel("Identifier")),
...
export const CreateStreamSessionAdminShellOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const Resolution = /*@__PURE__*/ S.suspend(() => S.Struct({ Width: S.Number, Height: S.Number })).annotate({ identifier: "Resolution" });
export const DisplayConfiguration = /*@__PURE__*/ S.suspend(() => S.Struct({ Resolution: S.optional(Resolution) })).annotate({
    identifier: "DisplayConfiguration",
});
export const CreateStreamUrlInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Identifier: S.String.pipe(T.HttpLabel("Identifier")),
    ...
    ClientToken: S.optional(S.String).pipe(T.IdempotencyToken()),
}).pipe(T.all(T.Http({ method: "POST", uri: "/streamgroups/{Identifier}/streamurls" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "CreateStreamUrlInput",
});
export const StreamUrlStatus = S.String;
export const StreamUrlStatusReason = S.String;
export const CreateStreamUrlOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Arn: S.String,
...
export const GetStreamUrlInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Identifier: S.String.pipe(T.HttpLabel("Identifier")),
...
export const GetStreamUrlOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Arn: S.String,
    StreamUrlId: S.optional(S.String),
    StreamUrl: S.optional(SensitiveString),
    Status: S.optional(StreamUrlStatus),
...
export const ListApplicationShaderCachesInput = /*@__PURE__*/ S.suspend(() => S.Struct({ Identifier: S.String.pipe(T.HttpLabel("Identifier")) }).pipe(T.all(T.Http({ method: "GET", uri: "/applications/{Identifier}/shadercaches" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ListApplicationShaderCachesInput",
});
export const ShaderCacheStatus = S.String;
export const ShaderCacheSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    Identifier: S.String,
...
export const ListApplicationShaderCachesOutput = /*@__PURE__*/ S.suspend(() => S.Struct({ Items: S.optional(ShaderCacheSummaryList) })).annotate({
...
export const ListStreamUrlsInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    ...
    NextToken: S.optional(S.String).pipe(T.HttpQuery("NextToken")),
    MaxResults: S.optional(S.Number).pipe(T.HttpQuery("MaxResults")),
}).pipe(T.all(T.Http({ method: "GET", uri: "/streamurls" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "ListStreamUrlsInput",
});
export const StreamUrlSummary = /*@__PURE__*/ S.suspend(() => S.Struct({
    Arn: S.String,
    StreamUrlId: S.optional(S.String),
    StreamUrl: S.optional(SensitiveString),
    Status: S.optional(StreamUrlStatus),
...
export const ListStreamUrlsOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const RevokeStreamUrlInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    Identifier: S.String.pipe(T.HttpLabel("Identifier")),
    StreamUrlIdentifier: S.String.pipe(T.HttpLabel("StreamUrlIdentifier")),
 ...
 */
export const createStreamSessionAdminShell = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const createStreamUrl = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getStreamUrl = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const listApplicationShaderCaches = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const listStreamUrls = /*@__PURE__*/ API.makePaginated(() => ({
 ...
 */
export const revokeStreamUrl = /*@__PURE__*/ API.make(() => ({
