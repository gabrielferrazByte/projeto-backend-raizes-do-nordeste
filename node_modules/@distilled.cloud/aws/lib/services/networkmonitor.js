            ...
            if (PartitionResult != null && PartitionResult !== false) {
                if (UseFIPS === true && UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsFIPS") &&
                        ...
                        return e(`https://networkmonitor-fips.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
                    return err("FIPS and DualStack are enabled, but this partition does not support one or both");
                }
                if (UseFIPS === true) {
                    if (_.getAttr(PartitionResult, "supportsFIPS") === true) {
                        return e(`https://networkmonitor-fips.${Region}.${_.getAttr(PartitionResult, "dnsSuffix")}`);
                    }
                    return err("FIPS is enabled but this partition does not support FIPS");
                }
                if (UseDualStack === true) {
                    if (true === _.getAttr(PartitionResult, "supportsDualStack")) {
                        return e(`https://networkmonitor.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                    }
...
export const CreateMonitorProbeInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    sourceArn: S.String,
...
export const ProbeInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    sourceArn: S.String,
    destination: S.String,
    destinationPort: S.optional(S.Number),
    protocol: Protocol,
    packetSize: S.optional(S.Number),
    tags: S.optional(TagMap),
})).annotate({ identifier: "ProbeInput" });
export const CreateProbeInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    monitorName: S.String.pipe(T.HttpLabel("monitorName")),
    probe: ProbeInput,
    clientToken: S.optional(S.String).pipe(T.IdempotencyToken()),
    tags: S.optional(TagMap),
}).pipe(T.all(T.Http({ method: "POST", uri: "/monitors/{monitorName}/probes" }), svc, auth, proto, ver, rules))).annotate({
    identifier: "CreateProbeInput",
});
export const AddressFamily = S.String;
export const ProbeState = S.String;
export const CreateProbeOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const DeleteProbeInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    monitorName: S.String.pipe(T.HttpLabel("monitorName")),
...
export const Probe = /*@__PURE__*/ S.suspend(() => S.Struct({
    probeId: S.optional(S.String),
    probeArn: S.optional(S.String),
    sourceArn: S.String,
    destination: S.String,
...
export const GetProbeInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    monitorName: S.String.pipe(T.HttpLabel("monitorName")),
    probeId: S.String.pipe(T.HttpLabel("probeId")),
}).pipe(T.all(T.Http({
    method: "GET",
    uri: "/monitors/{monitorName}/probes/{probeId}",
}), svc, auth, proto, ver, rules))).annotate({ identifier: "GetProbeInput" });
export const GetProbeOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    probeId: S.optional(S.String),
    probeArn: S.optional(S.String),
    sourceArn: S.String,
    destination: S.String,
    ...
    modifiedAt: S.optional(S.Date.pipe(T.TimestampFormat("epoch-seconds"))),
    tags: S.optional(TagMap),
})).annotate({ identifier: "GetProbeOutput" });
...
export const UpdateProbeInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    monitorName: S.String.pipe(T.HttpLabel("monitorName")),
    probeId: S.String.pipe(T.HttpLabel("probeId")),
    state: S.optional(ProbeState),
...
export const UpdateProbeOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
    probeId: S.optional(S.String),
    probeArn: S.optional(S.String),
    sourceArn: S.String,
    destination: S.String,
 ...
 * probe for.
 */
export const createProbe = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const deleteProbe = /*@__PURE__*/ API.make(() => ({
 ...
 */
export const getProbe = /*@__PURE__*/ API.make(() => ({
    input: GetProbeInput,
 ...
 * probe.
 */
export const updateProbe = /*@__PURE__*/ API.make(() => ({
