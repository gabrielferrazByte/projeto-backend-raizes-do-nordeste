...
const rules = T.EndpointResolver((p, _) => {
    const { Region, UseDualStack = false, UseFIPS = false, Endpoint, AccountId, AccountIdEndpointMode, ResourceArn, ResourceArnList, IsSearchOperation, } = p;
    const e = (u, p = {}, h = {}) => ({
        type: "endpoint",
    ...
    const _p0 = () => ({ metricValues: ["O"] });
    {
        ...
        if (Endpoint != null &&
            ...
            if (_.getAttr(parsedEndpoint, "authority") ===
            ...
            if (PartitionResult != null && PartitionResult !== false) {
                ...
                if (UseFIPS === true && UseDualStack === true) {
                    if (_.getAttr(PartitionResult, "supportsFIPS") === true &&
                        ...
                        if (IsSearchOperation != null && IsSearchOperation === true) {
                            return e(`https://search-dynamodb-fips.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                        }
                ...
                if (UseFIPS === true) {
                    if (_.getAttr(PartitionResult, "supportsFIPS") === true) {
                        ...
                        if (IsSearchOperation != null && IsSearchOperation === true) {
                            return e(`https://search-dynamodb-fips.${Region}.${_.getAttr(PartitionResult, "dnsSuffix")}`);
                        }
                    ...
                    if (_.getAttr(PartitionResult, "supportsDualStack") === true) {
                        {
                            ...
                            if (AccountIdEndpointMode != null &&
                                ...
                                if (IsSearchOperation != null && IsSearchOperation === true) {
                                    return e(`https://${_.getAttr(ParsedArn, "accountId")}.search-ddb.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`, _p0(), {});
                                }
                        ...
                        if (AccountIdEndpointMode != null &&
                            ...
                            if (_.isValidHostLabel(AccountId, false)) {
                                if (IsSearchOperation != null && IsSearchOperation === true) {
                                    return e(`https://${AccountId}.search-ddb.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`, _p0(), {});
                                }
                        ...
                        if (IsSearchOperation != null && IsSearchOperation === true) {
                            return e(`https://search-dynamodb.${Region}.${_.getAttr(PartitionResult, "dualStackDnsSuffix")}`);
                        }
                ...
                }
                {
                    ...
                    if (AccountIdEndpointMode != null &&
                        ...
                        _.isValidHostLabel(_.getAttr(ParsedArn, "accountId"), false)) {
                        if (IsSearchOperation != null && IsSearchOperation === true) {
                            return e(`https://${_.getAttr(ParsedArn, "accountId")}.search-ddb.${Region}.${_.getAttr(PartitionResult, "dnsSuffix")}`, _p0(), {});
                        }
                ...
                if (AccountIdEndpointMode != null &&
                    ...
                    if (_.isValidHostLabel(AccountId, false)) {
                        if (IsSearchOperation != null && IsSearchOperation === true) {
                            return e(`https://${AccountId}.search-ddb.${Region}.${_.getAttr(PartitionResult, "dnsSuffix")}`, _p0(), {});
                        }
...
export const VectorCapacity = /*@__PURE__*/ S.suspend(() => S.Struct({
    VectorSearchRequestBytes: S.optional(S.Number),
    VectorWriteRequestBytes: S.optional(S.Number),
})).annotate({ identifier: "VectorCapacity" });
export const VectorIndexesCapacityMap = /*@__PURE__*/ S.Record(S.String, VectorCapacity.pipe(S.optional));
...
export const VectorAttributeDefinition = /*@__PURE__*/ S.suspend(() => S.Struct({ AttributeName: S.String })).annotate({
    identifier: "VectorAttributeDefinition",
});
export const SearchSchemaElementType = S.String;
export const SearchSchemaElement = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const VectorIndex = /*@__PURE__*/ S.suspend(() => S.Struct({
    IndexName: S.String,
...
})).annotate({ identifier: "VectorIndex" });
...
export const VectorIndexDescription = /*@__PURE__*/ S.suspend(() => S.Struct({
    IndexName: S.optional(S.String),
    SearchSchema: S.optional(SearchSchema),
    Projection: S.optional(Projection),
...
export const VectorIndexInfo = /*@__PURE__*/ S.suspend(() => S.Struct({
    IndexName: S.optional(S.String),
    VectorAttribute: S.optional(VectorAttributeDefinition),
    SearchSchema: S.optional(SearchSchema),
    Projection: S.optional(Projection),
...
export const SearchVectorList = /*@__PURE__*/ S.Array(S.suspend(() => AttributeValue).annotate({ identifier: "AttributeValue" }));
export const SearchVectorsInput = /*@__PURE__*/ S.suspend(() => S.Struct({
    TableName: S.String.pipe(T.ContextParam("ResourceArn")),
    IndexName: S.String,
    ReturnConsumedCapacity: S.optional(ReturnConsumedCapacity),
    ExpressionAttributeNames: S.optional(ExpressionAttributeNameMap),
    ...
    TopK: S.Number,
}).pipe(T.all(ns, T.Http({ method: "POST", uri: "/" }), svc, auth, proto, ver, rules, T.StaticContextParams({ IsSearchOperation: { value: true } })))).annotate({
    identifier: "SearchVectorsInput",
});
export const SearchResultItem = /*@__PURE__*/ S.suspend(() => S.Struct({ Item: S.optional(AttributeMap), Score: S.optional(S.Number) })).annotate({
    identifier: "SearchResultItem",
});
export const SearchResultList = /*@__PURE__*/ S.Array(SearchResultItem);
export const SearchVectorsOutput = /*@__PURE__*/ S.suspend(() => S.Struct({
...
export const CreateVectorIndexAction = /*@__PURE__*/ S.suspend(() => S.Struct({
    IndexName: S.String,
    VectorAttribute: VectorAttributeDefinition,
    SearchSchema: S.optional(SearchSchema),
    Projection: Projection,
...
export const DeleteVectorIndexAction = /*@__PURE__*/ S.suspend(() => S.Struct({ IndexName: S.String })).annotate({
    identifier: "DeleteVectorIndexAction",
});
export const VectorIndexUpdate = /*@__PURE__*/ S.suspend(() => S.Struct({
 ...
 */
export const searchVectors = /*@__PURE__*/ API.make(() => ({
